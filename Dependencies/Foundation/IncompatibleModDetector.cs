...
/// gating of XML mutation is deferred to a future revision — DOTS Phase 4 ships
...
/// intentionally omitted; we'll revisit if DOTS users hit recurring crash-loops.
/// </summary>
        ...
        try
        {
            ...
            foreach (var dir in Directory.GetDirectories(modulesRoot))
            {
                ...
                try
                {
                    ...
                    // comment mentions `<Id value="DOTS.Dependencies"/>` and was
                    // recorded as DOTS.Dependencies (duplicate) instead of
                    // Bannerlord.Harmony.
