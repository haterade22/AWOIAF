...
/// <summary>
/// Resolves the canonical runtime-log path for DOTS.Dependencies. Used by DiagLog,
...
/// `DOTS.Dependencies.dll` location to `&lt;game&gt;/Modules/DOTS.Dependencies/`.
/// </summary>
public static class RuntimeLog
{
    ...
    /// (<c>&lt;game&gt;/Modules/DOTS.Dependencies/diag.log</c>). Returns empty string
    /// if the location can't be resolved.
    /// </summary>
    public static string Path => _path ??= ResolvePath();

    /// <summary>
    /// Absolute path to the DOTS.Dependencies module directory
    /// (<c>&lt;game&gt;/Modules/DOTS.Dependencies/</c>). Used by shield disable-flag
    ...
    private static string ResolveModuleDir()
    {
        try
        {
            // DOTS.Dependencies.dll lives at:
            //   <game>/Modules/DOTS.Dependencies/bin/Win64_Shipping_Client/DOTS.Dependencies.dll
            ...
            var moduleDir = System.IO.Path.GetDirectoryName(moduleBinDir);        // DOTS.Dependencies
