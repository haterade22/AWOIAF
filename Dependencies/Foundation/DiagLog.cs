...
/// <summary>
/// Structured runtime diagnostic logger for DOTS.Dependencies defensive infrastructure.
/// Writes to <c>&lt;game&gt;/Modules/DOTS.Dependencies/diag.log</c> (see RuntimeLog.Path).
    ...
    private static void EnsureHeader(string path)
    {
        try
        {
            ...
            var marker =
                $"{Environment.NewLine}" +
                $"# ============================================================{Environment.NewLine}" +
                $"# DOTS.Dependencies session start: {DateTime.Now:yyyy-MM-dd HH:mm:ss}{Environment.NewLine}" +
                $"# ============================================================{Environment.NewLine}";
