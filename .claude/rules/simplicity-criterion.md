...
Imported from karpathy/autoresearch `program.md` "Simplicity criterion" paragraph (March 2026). The original framing was for ML hyperparameter changes ("a 0.001 val_bpb improvement that adds 20 lines of hacky code? Probably not worth it. An improvement of ~0 but much simpler code? Keep."); this rule generalizes it to any DOTS code change.