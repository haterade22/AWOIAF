...
- `DOTS.Tests/Features/{feature}/` — all test files
...
- Check for convention consistency with other DOTS features
...
2. `dotnet build DOTS.Tests` — must compile
3. `dotnet test DOTS.Tests` — must pass
