...
Adapted from [affaan-m/everything-claude-code/skills/skill-stocktake](https://github.com/affaan-m/everything-claude-code/tree/main/skills/skill-stocktake) — DOTS version drops the multi-subagent batch evaluation and uses a leaner deterministic-scan + LLM-judgment two-pass.
