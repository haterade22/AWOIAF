...
- Carries over existing data (names, buildings, hearth, etc.) from DOTS_Map module
...
**Path**: `DOTS_Map/ModuleData/DistanceCaches/settlements_distance_cache_Default.bin`
**Size**: 7.83 MB
...
- **862** settlements in cache (vs 658 in DOTS's settlements.xml — cache includes all modules on the map)
