...
namespace DOTS.Tests.Features.BanditManagement;

/// <summary>
/// Cap()/Scale() are internal static (InternalsVisibleTo "DOTS.Tests") — they hold the only
/// computation in the otherwise-thin <see cref="DotsBanditDensityModel"/>, so they're unit-tested
...
/// </summary>
[TestClass]
public class DotsBanditDensityModelTests
{
    [TestMethod]
    public void Cap_HardCapBelowVanillaBase_ReturnsVanillaBase_NotHardCap()
    {
        ...
        Assert.AreEqual(3, DotsBanditDensityModel.Cap(3, 1.0f, 2));
    }
    ...
    public void Cap_HardCapBelowVanillaBase_HighMultiplier_StillFloorsAtBase()
    {
        ...
        Assert.AreEqual(9, DotsBanditDensityModel.Cap(9, 2.5f, 4));
    }
    ...
    public void Cap_MultiplierOne_ReturnsVanillaBase()
    {
        ...
        Assert.AreEqual(9, DotsBanditDensityModel.Cap(9, 1.0f, 100));
    }
    ...
    public void Cap_ScaledExceedsHardCap_ReturnsHardCap()
    {
        ...
        Assert.AreEqual(15, DotsBanditDensityModel.Cap(9, 2.5f, 15));
    }
    ...
    public void Cap_ScaledWithinRange_ReturnsScaled()
    {
        ...
        Assert.AreEqual(18, DotsBanditDensityModel.Cap(9, 2.0f, 100));
    }

    [TestMethod]
    public void Scale_MultiplierOne_ReturnsVanillaBase()
    {
        Assert.AreEqual(22, DotsBanditDensityModel.Scale(22, 1.0f));
    }

    [TestMethod]
    public void Scale_HigherMultiplier_ScalesUp()
    {
        Assert.AreEqual(44, DotsBanditDensityModel.Scale(22, 2.0f));
    }
}
