...
using DOTS.Features.SmartCavalryAI.Models;

namespace DOTS.Tests.Features.SmartCavalryAI;
...
// DotsSettings.Instance which inherits from MCMv5's AttributeGlobalSettings and triggers
...
// delegate (Func<DotsSettings?>) into the provider so the static singleton is mockable.
