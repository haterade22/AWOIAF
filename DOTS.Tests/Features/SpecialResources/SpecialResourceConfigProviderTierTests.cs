...
namespace DOTS.Tests.Features.SpecialResources;
...
public class SpecialResourceConfigProviderTierTests
{
    ...
    public void Setup()
    {
        _tempDir = Path.Combine(Path.GetTempPath(), "dots_tier_tests_" + System.Guid.NewGuid().ToString("N"));
...
<SpecialResources>
  <Resource id=""gems"" display_name=""Gems"" icon_sprite=""dots_gems_icon""
