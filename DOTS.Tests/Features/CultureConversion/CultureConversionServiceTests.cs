...
using DOTS.Features.CultureConversion.Domain;
using DOTS.Features.TroopProgression;

namespace DOTS.Tests.Features.CultureConversion;
...
public class CultureConversionServiceTests
{
    ...
    {
        // MCM contract (DotsSettings hint): "Disabling stops NEW conversions; already-converted settlements
