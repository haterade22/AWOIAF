...
public class NarrativeDataProviderTests
{
    ...
    public void Setup()
    {
        _tempDir = Path.Combine(Path.GetTempPath(), "DOTS_NAR_" + Path.GetRandomFileName());
    ...
    public void LoadMenuOptions_ParsesValidJson()
    {
        WriteJson("parents", @"[
            {
                ""string_id"": ""dots_parent_gondor_1"",
                ""culture_id"": ""gondor"",
        ...
        Assert.AreEqual("dots_parent_gondor_1", result[0].StringId);
