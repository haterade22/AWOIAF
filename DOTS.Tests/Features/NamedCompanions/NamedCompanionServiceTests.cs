...
namespace DOTS.Tests.Features.NamedCompanions;
...
public class NamedCompanionServiceTests
{
    ...
    public void Setup()
    {
        ...
        _sut = new NamedCompanionService(
            _configProvider, _companionAdapter, _heroRosterAdapter, _logger);
    }
    ...
    [TestMethod]
    public void SpawnCompanions_EnabledCompanion_SetsHumanRace()
    {
        // GoT is human-only — all companions use raceId=0 regardless of Race field value.
        SetupCompanions(new NamedCompanionDefinition
        {
            CharacterId = "named_companion_ned",
            SpawnSettlement = "town_M1",
            Race = "human",
            Enabled = true
        });
        _companionAdapter.HeroExists("named_companion_ned").Returns(true);

        _sut.SpawnCompanions();

        _heroRosterAdapter.Received(1).SetHeroRace("named_companion_ned", 0);
    }
    ...
    public void SpawnCompanions_MultipleCompanions_PlacesAllEnabled()
    {
        SetupCompanions(
            ...
            new NamedCompanionDefinition { CharacterId = "nc_b", SpawnSettlement = "town_2", Race = "human", Enabled = true },
            new NamedCompanionDefinition { CharacterId = "nc_c", SpawnSettlement = "town_3", Race = "human", Enabled = false }
        );
    ...
    public void ResetSession_AllowsSpawnCompanionsAgainInSameProcess()
    {
        ...
        // Campaign 2 — ResetSession clears the latch.
