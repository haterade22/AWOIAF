...
namespace DOTS.Tests.Features.CompanionTactics;
...
public class SharedMovementOrderPostfixTests
{
    private static string FindRepoRoot()
    {
        ...
        while (dir != null && !File.Exists(Path.Combine(dir.FullName, "DOTS.sln")))
            dir = dir.Parent;
        return dir?.FullName ?? throw new System.IO.FileNotFoundException("DOTS.sln not found walking upward from cwd");
    }
