...
namespace DOTS.Tests.Features.MainMenuCustomizer;
...
public class MainMenuCustomizerServiceTests
{
    ...
    public void CustomizeMenu_RenamesSandboxToEnterTheAgeOfMen()
    {
        ...
        _moduleMenuAdapter.Received(1).RenameOption("SandBoxNewGame", "{=dots_main_menu_new_game}Enter The Age Of Men");
    }
