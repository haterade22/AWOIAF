...
[TestClass]
public class DotsTournamentModelTests
{
    ...
    {
        Assert.AreEqual(DotsTournamentModel.RegularMaxTier, DotsTournamentModel.EliteMinTier);
    }

    [TestMethod]
    public void TierConstants_RegularMin_ExcludesJunkTier()
    {
        Assert.IsTrue(DotsTournamentModel.RegularMinTier > 0f);
    }

    [TestMethod]
    public void TierConstants_EliteMin_IsAboveRegularMin()
    {
        Assert.IsTrue(DotsTournamentModel.EliteMinTier > DotsTournamentModel.RegularMinTier);
    }

    [TestMethod]
    public void TournamentStartChance_DiminishingReturns_EachStepLowerThanPrevious()
    {
        // Phase 9b #137 — moved from DotsTournamentModel.TournamentStartChance* to
