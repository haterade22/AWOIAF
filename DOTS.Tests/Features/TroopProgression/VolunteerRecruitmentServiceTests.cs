...
namespace DOTS.Tests.Features.TroopProgression;
...
public class VolunteerRecruitmentServiceTests
{
    ...
    public void GetVolunteerTroopId_DolGuldurClanPool_ExcludesSpider()
    {
        ...
        Assert.AreNotEqual("dots_spider_creature", result);
    }
    ...
    // --- Mordor culture fallback (engine id "mordor", custom DOTS culture) ---
