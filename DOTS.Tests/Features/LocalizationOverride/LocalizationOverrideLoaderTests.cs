...
namespace DOTS.Tests.Features.LocalizationOverride;
...
<strings>
    <string id=""dots_the_fix_0cdXddA9"" text=""{=0cdXddA9}{KINGDOM1_LINK} has formed an alliance with {KINGDOM2_LINK}."" />
</strings>";
    ...
    [TestMethod]
    public void ParseOverrides_IgnoresEntriesWithDotsPrefixedIds()
    {
        // Arrange — entries whose {=ID} starts with "dots_" are DOTS's own strings, not overrides
        string xml = @"<?xml version=""1.0"" encoding=""utf-8""?>
<strings>
    <string id=""str_faction_official.empire"" text=""{=dots_str_faction_official.empire}a clansman of Dunland"" />
</strings>";
...
<strings>
    <string id=""dots_the_fix_0cdXddA9"" text=""{=0cdXddA9}{KINGDOM1_LINK} has formed an alliance with {KINGDOM2_LINK}."" />
    <string id=""dots_the_fix_1rbg3Hz2"" text=""{=1rbg3Hz2}{FACTION_1} and {FACTION_2} are no longer enemies."" />
    <string id=""str_faction_official.empire"" text=""{=dots_str_faction_official.empire}a clansman of Dunland"" />
</strings>";
