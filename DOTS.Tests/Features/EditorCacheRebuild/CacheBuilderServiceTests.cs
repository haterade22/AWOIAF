...
namespace DOTS.Tests.Features.EditorCacheRebuild;
...
public class CacheBuilderServiceTests
{
    ...
    private DOTS.Core.Infrastructure.IPathService _pathService = null!;
    ...
    public void Setup()
    {
        ...
        _pathService = Substitute.For<DOTS.Core.Infrastructure.IPathService>();
