...
public class FactionSelectionServiceTests
{
    ...
    public void FormatDifficultyText_ValidDifficulty_ReturnsKeyedString()
    {
        ...
        Assert.AreEqual("{=dots_faction_difficulty_1}Difficulty: Very Easy", _sut.FormatDifficultyText(1));
        Assert.AreEqual("{=dots_faction_difficulty_2}Difficulty: Easy", _sut.FormatDifficultyText(2));
        Assert.AreEqual("{=dots_faction_difficulty_3}Difficulty: Medium", _sut.FormatDifficultyText(3));
        Assert.AreEqual("{=dots_faction_difficulty_4}Difficulty: Medium-Hard", _sut.FormatDifficultyText(4));
        Assert.AreEqual("{=dots_faction_difficulty_5}Difficulty: Hard", _sut.FormatDifficultyText(5));
        Assert.AreEqual("{=dots_faction_difficulty_6}Difficulty: Very Hard", _sut.FormatDifficultyText(6));
        Assert.AreEqual("{=dots_faction_difficulty_7}Difficulty: Extreme", _sut.FormatDifficultyText(7));
    }
