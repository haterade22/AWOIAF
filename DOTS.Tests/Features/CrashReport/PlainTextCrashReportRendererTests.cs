...
namespace DOTS.Tests.Features.CrashReport;
...
public class PlainTextCrashReportRendererTests
{
    ...
    public void Render_MinimalContext_ProducesAllSections()
    {
        ...
        Assert.IsTrue(text.Contains("--- DOTS State ---"));
    ...
    private static ExceptionContext MakeMinimalContext()
    {
        return new ExceptionContext(
            ...
            Campaign: null,
            Mission: null,
            Dots: new DotsStateSnapshot(null, System.Array.Empty<SpecialResourceEntry>(), null, null, null),
