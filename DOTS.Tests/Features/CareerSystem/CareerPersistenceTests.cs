...
public class CareerPersistenceTests
{
    ...
    public void SyncData_RoundTrip_PreservesCareerAndChoices()
    {
        ...
        // Get what was saved
        savedCareerIds = saveStore.GetSaved<Dictionary<string, string>>("_dots_careerIds");
        savedChoices = saveStore.GetSaved<Dictionary<string, string>>("_dots_careerChoices");
        savedTiers = saveStore.GetSaved<Dictionary<string, string>>("_dots_careerTiers");
        ...
        loadStore.SetData("_dots_careerIds", savedCareerIds);
        loadStore.SetData("_dots_careerChoices", savedChoices);
        loadStore.SetData("_dots_careerTiers", savedTiers);
    ...
    public void SyncData_MultipleHeroes_AllPreserved()
    {
        ...
        var loadBehavior = new CareerPersistenceBehavior(freshService, Substitute.For<IModLogger>());
        var loadStore = new FakeDataStore { Mode = FakeDataStore.StoreMode.Loading };
        loadStore.SetData("_dots_careerIds", store.GetSaved<Dictionary<string, string>>("_dots_careerIds"));
        loadStore.SetData("_dots_careerChoices", store.GetSaved<Dictionary<string, string>>("_dots_careerChoices"));
        loadStore.SetData("_dots_careerTiers", store.GetSaved<Dictionary<string, string>>("_dots_careerTiers"));
        loadBehavior.SyncData(loadStore);
    ...
    public void SyncData_RoundTrip_PreservesFlags()
    {
        ...
        var savedFlags = store.GetSaved<Dictionary<string, string>>("_dots_careerFlags");
        ...
        var loadStore = new FakeDataStore { Mode = FakeDataStore.StoreMode.Loading };
        loadStore.SetData("_dots_careerIds", store.GetSaved<Dictionary<string, string>>("_dots_careerIds"));
        loadStore.SetData("_dots_careerFlags", savedFlags);
        loadBehavior.SyncData(loadStore);
