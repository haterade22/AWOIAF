...
[TestClass]
public class DotsCombatSimulationModelTests
{
    [TestMethod]
    public void CalculateBluntChance_PlayerBattle_ReturnsPlayerChance()
    {
        ...
        // Act
        float result = DotsCombatSimulationModel.CalculateBluntChance(true, playerChance, aiChance);
    ...
    public void CalculateBluntChance_AIBattle_ReturnsAIChance()
    {
        ...
        // Act
        float result = DotsCombatSimulationModel.CalculateBluntChance(false, playerChance, aiChance);
    ...
    public void CalculateBluntChance_PlayerChance_MatchesInput()
    {
        ...
        // Act
        float result = DotsCombatSimulationModel.CalculateBluntChance(true, playerChance, 0.05f);
    ...
    public void CalculateBluntChance_AIChance_MatchesInput()
    {
        ...
        // Act
        float result = DotsCombatSimulationModel.CalculateBluntChance(false, 0.30f, aiChance);
    ...
    {
        // Act
        float result = DotsCombatSimulationModel.CalculateBluntChance(isPlayerBattle, playerChance, aiChance);
