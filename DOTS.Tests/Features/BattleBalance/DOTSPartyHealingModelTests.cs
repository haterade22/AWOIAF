...
[TestClass]
public class DotsPartyHealingModelTests
{
    [TestMethod]
    public void ApplyCulturalSurvivalBonus_ZeroBonus_ReturnsVanillaUnchanged()
    {
        ...
        // Act
        float result = DotsPartyHealingModel.ApplyCulturalSurvivalBonus(vanillaSurvival, 0f);
    ...
    public void ApplyCulturalSurvivalBonus_PositiveBonus_ReducesDeathChance()
    {
        ...
        // Act
        float result = DotsPartyHealingModel.ApplyCulturalSurvivalBonus(vanillaSurvival, bonus);
