...
namespace DOTS.Tests.Features.BattleBalance;

[TestClass]
public class DotsMilitaryPowerModelTests
{
    ...
    public void CalculateTierPower_Tier7_ReturnsConfiguredValue()
    {
        ...
        // Act
        float result = DotsMilitaryPowerModel.CalculateTierPower(7, false, tier7Value, 3.26f, 3.61f, 3.96f, _defaultConfig);
    ...
    public void CalculateTierPower_Tier8_ReturnsConfiguredValue()
    {
        ...
        // Act
        float result = DotsMilitaryPowerModel.CalculateTierPower(8, false, 2.91f, tier8Value, 3.61f, 3.96f, _defaultConfig);
    ...
    public void CalculateTierPower_Tier9_ReturnsConfiguredValue()
    {
        ...
        // Act
        float result = DotsMilitaryPowerModel.CalculateTierPower(9, false, 2.91f, 3.26f, tier9Value, 3.96f, _defaultConfig);
    ...
    public void CalculateTierPower_Tier10_ReturnsConfiguredValue()
    {
        ...
        // Act
        float result = DotsMilitaryPowerModel.CalculateTierPower(10, false, 2.91f, 3.26f, 3.61f, tier10Value, _defaultConfig);
    ...
    public void CalculateTierPower_Tier6_VanillaFormula_Returns2Point56()
    {
        ...
        // Act
        float result = DotsMilitaryPowerModel.CalculateTierPower(6, false, 2.91f, 3.26f, 3.61f, 3.96f, _defaultConfig);
    ...
    public void CalculateTierPower_Tier6_OverrideEnabled_ReturnsConfigValue()
    {
        ...
        // Act
        float result = DotsMilitaryPowerModel.CalculateTierPower(6, true, 2.91f, 3.26f, 3.61f, 3.96f, _defaultConfig);
    ...
    public void CalculateTierPower_Tier11_FallsBackToFormulaViaConfig()
    {
        ...
        // Act
        float result = DotsMilitaryPowerModel.CalculateTierPower(11, false, 2.91f, 3.26f, 3.61f, 3.96f, _defaultConfig);
    ...
    {
        // Act
        float result = DotsMilitaryPowerModel.CalculateTierPower(tier, false, 2.91f, 3.26f, 3.61f, 3.96f, _defaultConfig);
    ...
    {
        // Act
        float result = DotsMilitaryPowerModel.CalculateTierPower(tier, true, 2.91f, 3.26f, 3.61f, 3.96f, _defaultConfig);
