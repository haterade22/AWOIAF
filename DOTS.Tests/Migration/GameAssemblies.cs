...
///
/// Why this exists: Main/DOTS.csproj references these module DLLs with <c>Private=False</c>, so they
/// are NOT copied into the test bin (only <c>TaleWorlds.*.dll</c> is, via DOTS.Tests.csproj's
...
internal static class GameAssemblies
{
    ...
    // StoryMode/CustomBattle/Native carry types some DOTS patches and adapters touch by name.
