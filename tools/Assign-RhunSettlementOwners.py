...
in the LIVE DOTS_Map module, replacing the single-clan monopoly
...
Do NOT confuse with the DOTS repo's Main/_Module/ModuleData/settlements.xml, which is a
stale shadow last touched 2026-04-06 and is NOT registered in SubModule.xml.
(See docs/reference/dots-map-settlement-naming.md + memory feedback_dots_map_live_vs_stale_shadow.md.)
...
def main():
    ap = argparse.ArgumentParser(description="Distribute Rhûn settlement ownership (DOTS_Map).")
