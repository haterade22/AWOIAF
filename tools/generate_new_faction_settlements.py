#!/usr/bin/env python3
"""Generate settlements.xml <Settlement> blocks for the three new DOTS kingdoms.

Source of truth: tools/dots_new_factions_layout.json (built from the live map scene
positions the user placed in DOTS_Map/SceneObj/Main_map/scene.xscene).
...
Inserts the blocks immediately before </Settlements> in the LIVE external file
  E:/Steam/.../Modules/DOTS_Map/ModuleData/settlements.xml
...
LAYOUT = os.path.join(ROOT, "tools", "dots_new_factions_layout.json")
LIVE = r"E:/Steam/steamapps/common/Mount & Blade II Bannerlord/Modules/DOTS_Map/ModuleData/settlements.xml"
...
def main():
    ...
    src = src.replace("</Settlements>", "  <!-- DOTS new factions: Misty Mountain Orcs / Goblins / Lindon -->\n" + xml + "</Settlements>")
