...
Three idempotent operations (re-running replaces, never duplicates):
  ...
  C. dots_partyTemplates.xml   (all)            -> upsert <MBPartyTemplate id="<template_id>"> with the roster
...
PARTY_TMPL = os.path.join(MD, "dots_partyTemplates.xml")
...
def main():
    ...
    print("WROTE clans.xml, spclans.xslt, dots_partyTemplates.xml (+ .bak each)")
