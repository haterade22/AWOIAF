...
# -*- coding: utf-8 -*-
"""
Apply lore-appropriate display names to DOTS map villages in DOTS_Map module.

Targets the LIVE engine-loaded files at:
    E:\\Steam\\...\\Modules\\DOTS_Map\\ModuleData\\settlements.xml
    E:\\Steam\\...\\Modules\\DOTS_Map\\ModuleData\\Languages\\<LANG>\\loc_settlements.xml  (x12)

Do NOT confuse with DOTS repo's Main/_Module/ModuleData/settlements.xml, which is a
...
See docs/reference/dots-map-settlement-naming.md for:
  - Region-prefix → culture → linguistic idiom mapping
  - How to add new mappings safely
  - Why the DOTS repo settlements.xml is NOT the source of truth
...
ROOT = r"E:\Steam\steamapps\common\Mount & Blade II Bannerlord\Modules\DOTS_Map\ModuleData"
