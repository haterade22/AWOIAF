<#
.SYNOPSIS
    Generates settlements.xml from scene.xscene entity data and existing DOTS_Map data.
.DESCRIPTION
...
param(
    ...
    [string]$ExistingSettlements = "E:\Steam\steamapps\common\Mount & Blade II Bannerlord\Modules\DOTS_Map\ModuleData\settlements.xml",
