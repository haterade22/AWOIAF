"""
creature_anim_ops.py - reusable Blender bpy operations for the DOTS creature animation pipeline.

Runs INSIDE Blender (needs bpy). Load via the Blender MCP / Python console:
    exec(open(r'C:\\Users\\mikew\\source\\repos\\DOTS\\tools\\blender\\creature_anim_ops.py').read(), globals())
