"""
skeleton_spec.py - declarative creature-skeleton spec + bpy scaffolder for the DOTS pipeline.
...
Runs INSIDE Blender (needs bpy). Load via the Blender MCP / console:
  exec(open(r'C:\\Users\\mikew\\source\\repos\\DOTS\\tools\\blender\\skeleton_spec.py').read(), globals())
