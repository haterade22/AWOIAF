"""Harvest {=KEY}default strings from factions.json into dots_module_strings.xml.
...
dots_module_strings.xml inside a clearly-marked block.
...
STRINGS_XML = REPO_ROOT / "Main" / "_Module" / "ModuleData" / "dots_module_strings.xml"
...
def main() -> None:
    ...
    if existing_start != -1 and existing_end != -1:
        ...
        if close_idx == -1:
            raise SystemExit("</strings> closer not found in dots_module_strings.xml")
