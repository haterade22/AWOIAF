...
# --------------------------------------------------------------------------- #
# Issue model (mirrors dots_schema.Issue: severity + location + message)       #
# --------------------------------------------------------------------------- #
class Severity(Enum):
    ERROR = "ERROR"
    WARNING = "WARNING"
...
# example would otherwise look like a real ref). Mirrors dots_schema._COMMENT_RE.
...
# --------------------------------------------------------------------------- #
# Reporting (mirrors dots_schema.format_report + adds the tier/grouping body)  #
# --------------------------------------------------------------------------- #
