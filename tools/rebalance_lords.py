#!/usr/bin/env python3
"""
Lord Skill Rebalancing Script for DOTS
...
Baselines derived from vanilla sandbox_skill_sets.xml, scaled up ~20% for DOTS
power level, then anchored to existing DOTS lord medians.
...
# =============================================================================
# Anchored to vanilla sandbox_skill_sets.xml medians, scaled ~20% up for DOTS.
...
# Cultural Modifiers
# =============================================================================
# Vanilla culture -> DOTS culture mapping
CULTURE_MAP = {
    # Vanilla cultures -> DOTS
...
def calculate_skills(archetype, is_rookie, is_ruler, culture, age, legendary):
    ...
    dots_culture = CULTURE_MAP.get(culture, '')
    mods = CULTURAL_MODS.get(dots_culture, {})
