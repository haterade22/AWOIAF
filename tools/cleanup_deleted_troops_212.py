...
- Remove `<PartyTemplateStack troop="NPCCharacter.<id>" .../>` from `dots_partyTemplates.xml`
...
TARGETS = {
    "dots_partyTemplates": "Main/_Module/ModuleData/dots_partyTemplates.xml",
...
CLEANUP = {
    "dots_partyTemplates": remove_party_template_stack,
