...
DOTS's Gondor settlements point their center / village_center Location scenes at a
mix of vanilla `empire_*` scenes and (now-broken) LOTR-named placeholder refs. Real
generic Gondor scenes now exist in `DOTS_Map/SceneObj`:

  - 3 castle scenes : dots_gondor_castle_001/002/003_forceatmo
  - 4 village scenes: dots_gondor_village_001/002/003/004_forceatmo
...
the live settlements.xml (DOTS_Map external module), preserving all other formatting
...
DEFAULT_SETTLEMENTS = Path(
    ...
    r"\Modules\DOTS_Map\ModuleData\settlements.xml"
)

GONDOR_CULTURE = 'culture="Culture.gondor"'

CASTLE_SCENES = [
    "dots_gondor_castle_001_forceatmo",
    "dots_gondor_castle_002_forceatmo",
    "dots_gondor_castle_003_forceatmo",
]
VILLAGE_SCENES = [
    "dots_gondor_village_001_forceatmo",
    "dots_gondor_village_002_forceatmo",
    "dots_gondor_village_003_forceatmo",
    "dots_gondor_village_004_forceatmo",
]
NAMED_TOWN_SCENES = {
    "town_EW1": "dots_gondor_town_minas_tirith_forceatmo",
    "town_EW2": "dots_gondor_town_osgiliath_w_forceatmo",
    "town_EW3": "dots_gondor_town_osgiliath_e_forceatmo",
    "town_EW7": "dots_gondor_town_lossarnach_forceatmo",
}
