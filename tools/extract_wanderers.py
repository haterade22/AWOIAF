"""
Extract and convert LOTRAOM wanderer data into DOTS format.

Produces 4 output files:
1. dots_wanderers.xml - NPCCharacter templates
2. dots_wanderer_skill_sets.xml - SkillSet definitions
3. dots_wanderer_equipment.xml - Per-culture companion equipment rosters
4. dots_wanderer_strings.xml - Backstory dialogue strings
"""
...
DOTS_BASE = r"c:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData"
...
def main():
    ...
    write_wanderer_npcs(
        by_kingdom,
        os.path.join(DOTS_BASE, "dots_wanderers.xml")
    )

    write_skill_sets(
        skill_sets,
        os.path.join(DOTS_BASE, "dots_wanderer_skill_sets.xml")
    )

    write_equipment(
        os.path.join(DOTS_BASE, "dots_wanderer_equipment.xml")
    )

    write_strings(
        strings,
        os.path.join(DOTS_BASE, "dots_wanderer_strings.xml")
    )
