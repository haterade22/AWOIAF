#!/usr/bin/env python3
"""
Settlement Name & Owner Merge Tool for DOTS

Copies `name` and `owner` attributes from the authoritative repo settlements.xml
into the map maker's DOTS_Map settlements.xml, preserving all positional data,
...
MAP_FILE = os.environ.get(
    'DOTS_MAP_FILE',
    r'E:\Steam\steamapps\common\Mount & Blade II Bannerlord\Modules\DOTS_Map\ModuleData\settlements.xml'
)
