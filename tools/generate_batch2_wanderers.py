...
Appends to existing dots_wanderers.xml, dots_wanderer_skill_sets.xml,
dots_wanderer_equipment.xml, dots_wanderer_strings.xml.
"""
import random
import os
...
BASE_DIR = r"c:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData"
...
def main():
    ...
    wanderers_file = os.path.join(BASE_DIR, 'dots_wanderers.xml')
    skills_file = os.path.join(BASE_DIR, 'dots_wanderer_skill_sets.xml')
    equip_file = os.path.join(BASE_DIR, 'dots_wanderer_equipment.xml')
    strings_file = os.path.join(BASE_DIR, 'dots_wanderer_strings.xml')
