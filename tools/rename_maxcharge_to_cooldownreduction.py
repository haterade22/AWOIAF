#!/usr/bin/env python3
"""Issue #104 Option B — repurpose 98 dead MaxCharge mutations in dots_career_choices.xml as
...
XML_PATH = ROOT / "Main" / "_Module" / "ModuleData" / "career_system" / "dots_career_choices.xml"
