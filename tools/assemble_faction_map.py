...
FULL_MAP_PATH = os.environ.get("DOTS_MAP_IMAGE", r"C:\Users\mikew\Downloads\Vista_dot-settlements-with-borders.png")
REGIONS_DIR = os.environ.get("DOTS_REGIONS_DIR", r"E:\LOTRAOMAssets\Culture Selection")
OUTPUT_DIR = os.environ.get("DOTS_FACTION_MAP_OUTPUT", str(Path(__file__).parent / "factionmap_output"))
...
def main():
    ...
    print(f"  2. Copy deploy/*.png to Modules/DOTS/GUI/SpriteData/FactionMap/")
    print(f"  3. Copy deploy/fullres/*.png to Modules/DOTS/GUI/SpriteData/FactionMap/fullres/")
