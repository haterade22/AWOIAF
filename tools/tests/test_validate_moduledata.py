#!/usr/bin/env python3
"""Unit tests for the schema-driven ModuleData validator (tools/dots_schema.py).
...
Each test maps to one recurring DOTS bug class the validator must catch:
  ...
  - DUPLICATE_NPC_ID       -> same NPCCharacter id defined twice in DOTS
...
import dots_schema as ts  # noqa: E402
...
""")
    ...
    def test_missing_civilian_equipment_type_is_flagged(self):
        _write(self.md / "equipmentsets" / "dots_equipment_sets_test.xml", """<?xml version="1.0" encoding="utf-8"?>
<EquipmentRosters>
...
""")
    ...
    def test_troop_ref_via_troop_attribute_is_checked(self):
        ...
        _write(self.md / "dots_partyTemplates.xml", """<?xml version="1.0" encoding="utf-8"?>
<partyTemplates>
...
""")
    ...
    def test_broken_party_template_ref_is_warning(self):
        _write(self.md / "dots_spcultures.xml", """<?xml version="1.0" encoding="utf-8"?>
<SPCultures>
...
""")
    ...
    def test_duplicate_roster_id_is_flagged(self):
        _write(self.md / "equipmentsets" / "dots_equipment_sets_a.xml", """<?xml version="1.0" encoding="utf-8"?>
<EquipmentRosters>
  <EquipmentRoster id="dup_roster" culture="Culture.gondor"><EquipmentSet /></EquipmentRoster>
</EquipmentRosters>
""")
        _write(self.md / "equipmentsets" / "dots_lord_template_equipment.xml", """<?xml version="1.0" encoding="utf-8"?>
<EquipmentRosters>
  <EquipmentRoster id="dup_roster" culture="Culture.gondor"><EquipmentSet /></EquipmentRoster>
</EquipmentRosters>
""")
        # dots_lord_template_equipment.xml must be covered by the broadened
...
""")
    ...
    def test_child_template_roster_requires_civilian_type(self):
        ...
        _write(self.md / "equipmentsets" / "dots_child_equipment_templates.xml", """<?xml version="1.0" encoding="utf-8"?>
<EquipmentRosters>
...
""")
    ...
    def test_education_template_roster_not_flagged(self):
        ...
        _write(self.md / "equipmentsets" / "dots_education_equipment_templates.xml", """<?xml version="1.0" encoding="utf-8"?>
<EquipmentRosters>
...
""")
    ...
    def test_civilian_rule_checks_all_equipment_sets(self):
        ...
        _write(self.md / "equipmentsets" / "dots_equipment_sets_x.xml", """<?xml version="1.0" encoding="utf-8"?>
<EquipmentRosters>
...
class BuildRegistriesTests(unittest.TestCase):
    ...
    def test_culture_registry_excludes_config_file_culture_ids(self):
        _write(self.md / "dots_spcultures.xml",
               '<?xml version="1.0"?>\n<SPCultures>\n  <Culture id="gondor" />\n</SPCultures>\n')
        # A feature config file that reuses <Culture id="..."> for kingdom/eligibility ids.
        _write(self.md / "career_system" / "dots_careers.xml",
               '<?xml version="1.0"?>\n<Careers>\n  <Culture id="empire_w" />\n  <Culture id="empire_s" />\n</Careers>\n')
