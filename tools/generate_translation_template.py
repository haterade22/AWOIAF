#!/usr/bin/env python3
"""
Generate translation template files from DOTS English source strings.
...
DOTS_BASE = Path("Main/_Module/ModuleData")
LANG_DIR = DOTS_BASE / "Languages"

# (source file, target filename template, description)
SOURCES = [
    (DOTS_BASE / "dots_module_strings.xml",
     "std_dots_module_strings_{locale}.xml",
     "module strings"),
    (DOTS_BASE / "dots_wanderer_strings.xml",
     "std_dots_wanderer_strings_{locale}.xml",
     "wanderer strings"),
    (DOTS_BASE / "named_companions" / "named_companion_strings.xml",
     "std_dots_named_companion_strings_{locale}.xml",
     "named companion strings"),
    (DOTS_BASE / "dots_cc_strings.xml",
     "std_dots_cc_strings_{locale}.xml",
     "character creation strings"),
    (DOTS_BASE / "dots_career_strings.xml",
     "std_dots_career_strings_{locale}.xml",
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate DOTS translation template files from English source strings.")
