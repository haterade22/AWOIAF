...
# -*- coding: utf-8 -*-
"""
Generalized, multi-region settlement-ownership distributor for the LIVE DOTS_Map module.
...
def main():
    ap = argparse.ArgumentParser(description="Distribute settlement ownership across clans (DOTS_Map).")
