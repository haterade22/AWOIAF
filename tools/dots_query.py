#!/usr/bin/env python3
"""Query API over the DOTS ModuleData validation engine (tools/dots_schema.py).

Pure-stdlib, importable, unit-tested. Backs the MCP server
(tools/dots_mcp_server.py) and is usable directly from other tooling. Decoupled
...
# The engine (dots_schema.REF_KINDS) names the troop kind "npccharacter"; the
