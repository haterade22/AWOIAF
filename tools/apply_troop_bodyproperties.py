#!/usr/bin/env python3
"""Wire each DOTS troop's body-property template to its culture/race.
...
culture- and race-appropriate templates defined in DOTS_bodyproperties.xml,
...
BODYPROPS_XML = REPO_ROOT / "Main" / "_Module" / "ModuleData" / "DOTS_bodyproperties.xml"
...
def load_valid_templates():
    """Build the set of valid custom template ids from DOTS_bodyproperties.xml."""
