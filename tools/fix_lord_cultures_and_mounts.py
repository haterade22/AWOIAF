...
5. Add Horse/HorseHarness to battle equipment templates in dots_equipment_sets_*.xml
...
def add_mounts_to_equipment(filepath, dry_run):
    ...
    fname = filepath.stem  # e.g. dots_equipment_sets_gondor
    culture = fname.replace("dots_equipment_sets_", "")
...
def main():
    ...
    equipment_files = sorted(MODULE_DATA.glob("dots_equipment_sets_*.xml"))
