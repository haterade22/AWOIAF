...
(dots_career_strings.xml) and inline defaults (dots_career_choices.xml) are already
...
KEYS_TO_5 = [
    "dots_buc_t3_b_p4_desc", "dots_mc_t3_b_p4_desc", "dots_sr_t3_b_p3_desc",
    "dots_ohw_t3_a_p3_desc", "dots_moa_t3_b_p4_desc", "dots_ew_t3_a_p3_desc",
    "dots_ws_t3_b_p4_desc", "dots_cr_t3_a_p3_desc",
]
KEYS_TO_6 = [
    "dots_ohw_t3_b_p4_desc", "dots_ew_t3_b_p4_desc", "dots_alr_t3_b_p4_desc",
    "dots_wh_t3_b_p4_desc", "dots_cr_t3_b_p2_desc",
]
...
def process_file(path: Path, apply: bool):
    ...
    for i, line in enumerate(lines):
        for key in KEYS_TO_5 + KEYS_TO_6:
            # Match the key as a token so e.g. dots_cr_t3_a_p3_desc doesn't match a longer id.
...
def main():
    ...
    total = 0
    lang_files = sorted(LANG_DIR.glob("*/std_dots_career_strings_*.xml"))
