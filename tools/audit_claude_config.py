#!/usr/bin/env python3
"""Audit DOTS's Claude Code configuration surface for security issues.

Deterministic, offline, stdlib-only. A portable subset of affaan-m/ECC's
"AgentShield" rule set, CALIBRATED TO DOTS. The notable calibration: DOTS
...
# --------------------------------------------------------------------------- #
# Hook exfiltration rules  (.claude/hooks scripts only; fail-open is OK in DOTS)
# --------------------------------------------------------------------------- #
...
def main(argv: list[str]) -> int:
    ap = argparse.ArgumentParser(description="Audit DOTS's Claude Code config surface for security issues.")
