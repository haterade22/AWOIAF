"""
Generate character creation equipment rosters for DOTS's 12 custom cultures.

Outputs: Main/_Module/ModuleData/equipmentsets/dots_char_creation_equipment.xml
...
OUTPUT_PATH = os.path.join(
    ...
    "..", "Main", "_Module", "ModuleData", "equipmentsets", "dots_char_creation_equipment.xml"
)
...
def main():
    ...
    xml_lines = [
        ...
        '<!--',
        f'  DOTS Character Creation Equipment Rosters ({count} rosters for 12 custom cultures)',
