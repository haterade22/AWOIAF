...
$taomXsltPath = "c:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\lords.xslt"
$outputPath = "c:\Users\mikew\source\repos\DOTS\scripts\new_lords_templates.xml"

# Read LOTRAOM lords.xml
Write-Host "Reading LOTRAOM lords.xml..."
[xml]$lotraomXml = Get-Content $lotraomLordsPath -Raw

# Read current DOTS lords.xslt
...
$missingIds | Out-File "c:\Users\mikew\source\repos\DOTS\scripts\missing_lord_ids.txt" -Encoding UTF8
