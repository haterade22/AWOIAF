...
# and create a new lords.xml file for DOTS

param(
    [string]$LordIdsFile = "c:\Users\mikew\source\repos\DOTS\scripts\missing_lord_ids.txt",
    [string]$SourceXmlFile = "E:\LOTRAOMAssets\LOTRAOM_Jan_1_Patreon\Modules\LOTRAOM\ModuleData\lords.xml",
    [string]$OutputFile = "c:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\characters\lords.xml"
)
...
# Add header comment
$headerComment = $outputXml.CreateComment(" DOTS Additional Lords - New lords from LOTRAOM not in vanilla Bannerlord `r`n     NOT registered in SubModule.xml - staged for future activation ")
