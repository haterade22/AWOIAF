...
| `anf_client_prediction` | `0x2000` | MP: predict the clip on any client. | **MP-only — irrelevant to SP DOTS creatures.** |
...
**Net for a DOTS creature (spider/warg):** the flags that matter are Cat 1 priority (continue/attack/striked/die),
