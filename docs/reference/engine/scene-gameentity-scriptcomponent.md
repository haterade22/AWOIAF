...
> editor surfaces per-instance config. This is the backbone under DOTS's `Main/SceneScripts` (CS_Road, etc.) and
...
- DOTS: `Main/SceneScripts/` (CS_Road), `docs/features/scene-scripts.md`, `feedback_editor_fields_are_config`; the howdah prefab pattern in [howdah-crew-mechanism.md](../features/elephant/howdah-crew-mechanism.md).
