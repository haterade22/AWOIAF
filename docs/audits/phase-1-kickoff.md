...
- [Main/Features/DotsSettings.cs](../../Main/Features/DotsSettings.cs) — MCM sections
...
**Target features:** CulturalFeats (17 models), Arena (1 model), Encyclopedia (1 model), any feature with `AddModel(new DotsXxx(...))` constructed inline without IoC

**Procedure per model:**
1. Open `Main/Features/<Feature>/Models/DotsXxx.cs`.
