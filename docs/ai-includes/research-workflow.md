...
> **Complement to**: [taleworlds-research-guide.md](./taleworlds-research-guide.md), which covers DOTS-specific research (TaleWorlds types, decompiled sources, game engine behavior). This guide covers **general research practices**.
