...
Overview of the DOTS project architecture and design decisions.
...
|-----------|-------------|---------------|
| Services | 100% | `DOTS.Tests/Features/` |
| Engines | 100% | `DOTS.Tests/Features/` |
| Adapters | Core methods | `DOTS.Tests/Adapters/` |
| Hooks | 80%+ | `DOTS.Tests/Features/` |
