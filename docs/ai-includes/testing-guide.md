...
Comprehensive guide for testing in the DOTS project.
...
using NSubstitute;
using DOTS.Features.CombatBonus;
using DOTS.Adapters;

namespace DOTS.Tests.Features.CombatBonus;
...
dotnet test DOTS.Tests/DOTS.Tests.csproj
