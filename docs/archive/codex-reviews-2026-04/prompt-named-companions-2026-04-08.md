...
6. WANDERER RACE FIX: In dots_wanderers.xml, confirm that ALL 10 Rivendell, 10 Mirkwood, and 10 Lothlorien wanderers have `race="elf"`, and ALL 10 Dolguldur wanderers have `race="dg_uruk"` with `BodyProperty.fighter_dolguldur`.
...
### Tests
- DOTS.Tests/Features/NamedCompanions/NamedCompanionConfigProviderTests.cs
- DOTS.Tests/Features/NamedCompanions/NamedCompanionServiceTests.cs
...
- Main/_Module/ModuleData/equipmentsets/dots_equipment_sets_named_companions.xml
...
### Wanderer Race Fix
- Main/_Module/ModuleData/dots_wanderers.xml (race attributes on elven + DG wanderers)
...
- Every finding must show DOTS code AND vanilla code side-by-side where relevant
