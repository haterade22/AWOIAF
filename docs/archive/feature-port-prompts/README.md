...
6. **MCM settings** — exact settings to append to [`DotsSettings.cs`](../../Main/Features/DotsSettings.cs)
...
3. TDD cycle:
   ...
   d. Build: dotnet build Main/DOTS.csproj -c Debug
   e. Test: dotnet test DOTS.Tests/DOTS.Tests.csproj --filter "FullyQualifiedName~<FeatureName>"
...
9. If RCA produces a generalizable lesson: codify it as a feedback memory in C:/Users/mikew/.claude/projects/c--Users-mikew-source-repos-DOTS/memory/ and index it in MEMORY.md
