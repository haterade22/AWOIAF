...
- **DOTS requirement:** What we need instead and why
...
- `DOTS.Tests/Features/<Name>/ServiceTests.cs` — N tests covering [summary]
- `DOTS.Tests/Features/<Name>/BehaviorTests.cs` — N tests covering [summary]
