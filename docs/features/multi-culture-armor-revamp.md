...
- **DOTS requirement (user direction):** "use the spec as a guide, but create variations within that guide to use all meshes. It is important all armor is showed off."
...
- **Issue:** [#211 — feat(armory): KEYforce multi-culture armor revamp](https://github.com/haterade22/DOTS/issues/211)
