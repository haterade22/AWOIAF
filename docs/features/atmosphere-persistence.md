...
- **DOTS requirement:** Certain Middle-earth locations (Dead Marshes, Moria, Fangorn) require permanent atmosphere effects that shouldn't change with seasons or time.
...
- `DOTS.Tests/Features/AtmospherePersistence/AtmosphereOverrideServiceTests.cs` — 7 tests covering null, empty, case-insensitive, marker at start/middle/end, negative case
...
- **Issue:** #43 — [feat: atmosphere persistence for forced-atmosphere scenes](https://github.com/haterade22/DOTS/issues/43)
- **Status:** Closed
