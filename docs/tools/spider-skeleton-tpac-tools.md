...
GitHub: `haterade22/DOTS` repo, `bannerlord-1.4.5` branch, `tools/` directory.

| Tool | Browse | Raw download |
|---|---|---|
| `tpac_skeleton_scan.py` | [view](https://github.com/haterade22/DOTS/blob/bannerlord-1.4.5/tools/tpac_skeleton_scan.py) | [raw](https://raw.githubusercontent.com/haterade22/DOTS/bannerlord-1.4.5/tools/tpac_skeleton_scan.py) |
| `tpac_skeleton_dump.py` | [view](https://github.com/haterade22/DOTS/blob/bannerlord-1.4.5/tools/tpac_skeleton_dump.py) | [raw](https://raw.githubusercontent.com/haterade22/DOTS/bannerlord-1.4.5/tools/tpac_skeleton_dump.py) |
| `tpac_skeleton_transplant.py` | [view](https://github.com/haterade22/DOTS/blob/bannerlord-1.4.5/tools/tpac_skeleton_transplant.py) | [raw](https://raw.githubusercontent.com/haterade22/DOTS/bannerlord-1.4.5/tools/tpac_skeleton_transplant.py) |
| `extract_fbx_bones.js` | [view](https://github.com/haterade22/DOTS/blob/bannerlord-1.4.5/tools/extract_fbx_bones.js) | [raw](https://raw.githubusercontent.com/haterade22/DOTS/bannerlord-1.4.5/tools/extract_fbx_bones.js) |
| `check_fbx_ik.js` | [view](https://github.com/haterade22/DOTS/blob/bannerlord-1.4.5/tools/check_fbx_ik.js) | [raw](https://raw.githubusercontent.com/haterade22/DOTS/bannerlord-1.4.5/tools/check_fbx_ik.js) |
| `blender_bone_retargeter.py` (Blender add-on, separate workflow) | [view](https://github.com/haterade22/DOTS/blob/bannerlord-1.4.5/tools/blender_bone_retargeter.py) | [raw](https://raw.githubusercontent.com/haterade22/DOTS/bannerlord-1.4.5/tools/blender_bone_retargeter.py) |
...
mkdir -p tools
cd tools
curl -O https://raw.githubusercontent.com/haterade22/DOTS/bannerlord-1.4.5/tools/tpac_skeleton_scan.py
curl -O https://raw.githubusercontent.com/haterade22/DOTS/bannerlord-1.4.5/tools/tpac_skeleton_dump.py
curl -O https://raw.githubusercontent.com/haterade22/DOTS/bannerlord-1.4.5/tools/tpac_skeleton_transplant.py
```
...
The transplant tool's only creature-specific logic lives in one function: `classify_bone(name)` in [`tpac_skeleton_transplant.py`](https://github.com/haterade22/DOTS/blob/bannerlord-1.4.5/tools/tpac_skeleton_transplant.py). The pattern is:
...
- Built for **DOTS** (Tales From The Age of Men), a LOTR total-conversion mod for Mount & Blade II: Bannerlord 1.4.5.
- Source repo: [github.com/haterade22/DOTS](https://github.com/haterade22/DOTS) (`bannerlord-1.4.5` branch)
