...
This document tracks XML schema changes between Bannerlord versions to ensure DOTS mod compatibility.
...
| Kingdom ID | DOTS Name | Lord Count | Clan Count |
|------------|-----------|------------|------------|
