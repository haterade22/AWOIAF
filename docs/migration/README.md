...
This directory contains documentation for migrating DOTS from Bannerlord 1.2.12 to 1.3.12.
...
DOTS uses XSLT transformations to modify vanilla Bannerlord XML at load time. This approach:
