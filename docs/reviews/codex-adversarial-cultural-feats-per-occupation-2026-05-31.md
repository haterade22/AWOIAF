...
|---|---:|---:|---|---|---|---|
| `dots_isengard_notable_count_town_merchant` | `DotsCulturalFeats.cs:554` | `2f` | `true` | `Add` | 2 -> 4 | Clean |
| `dots_isengard_notable_count_town_artisan` | `DotsCulturalFeats.cs:558` | `1f` | `true` | `Add` | 1 -> 2 | Clean |
| `dots_isengard_notable_count_town_gang_leader` | `DotsCulturalFeats.cs:562` | `12f` | `true` | `Add` | 2 -> 14 | Clean |
| `dots_dolguldur_notable_count_town_merchant` | `DotsCulturalFeats.cs:662` | `1f` | `true` | `Add` | 2 -> 3 | Clean |
| `dots_dolguldur_notable_count_town_artisan` | `DotsCulturalFeats.cs:666` | `1f` | `true` | `Add` | 1 -> 2 | Clean |
| `dots_dolguldur_notable_count_town_gang_leader` | `DotsCulturalFeats.cs:670` | `13f` | `true` | `Add` | 2 -> 15 | Clean |
| `dots_mordor_notable_count_town_gang_leader` | `DotsCulturalFeats.cs:747` | `2f` | `true` | `Add` | 2 -> 4 | Clean |
| `dots_gundabad_notable_count_town_artisan` | `DotsCulturalFeats.cs:601` | `1f` | `true` | `Add` | 1 -> 2 | Clean |
| `dots_gundabad_notable_count_town_gang_leader` | `DotsCulturalFeats.cs:605` | `3f` | `true` | `Add` | 2 -> 5 | Clean |
...
Pool counts from `dots_spcultures.xml` templates joined to the NPC files:
...
```text
dots_isengard_notable_count_town_merchant      | C# Register? YES | XML feat? YES
dots_isengard_notable_count_town_artisan       | C# Register? YES | XML feat? YES
dots_isengard_notable_count_town_gang_leader   | C# Register? YES | XML feat? YES
dots_dolguldur_notable_count_town_merchant     | C# Register? YES | XML feat? YES
dots_dolguldur_notable_count_town_artisan      | C# Register? YES | XML feat? YES
dots_dolguldur_notable_count_town_gang_leader  | C# Register? YES | XML feat? YES
dots_mordor_notable_count_town_gang_leader     | C# Register? YES | XML feat? YES
dots_gundabad_notable_count_town_artisan       | C# Register? YES | XML feat? YES
dots_gundabad_notable_count_town_gang_leader   | C# Register? YES | XML feat? YES
```
...
Deleted uniform town IDs: no matches in production/config/test/feature-doc surfaces (`Main/`, `DOTS.Tests/`, `docs/features/`, `CHANGELOG.md`) for the deleted exact IDs with a trailing XML/C# quote. Historical review logs and this prompt naturally mention the old IDs and were not treated as dead config.

Village feat isolation:

```text
dots_isengard_notable_count_village   | C# Register? YES | XML feat? YES | AddFactor 0.10
dots_dolguldur_notable_count_village  | C# Register? YES | XML feat? YES | AddFactor 0.10
dots_mordor_notable_count_village     | C# Register? YES | XML feat? YES | AddFactor 0.05
dots_gundabad_notable_count_village   | C# Register? YES | XML feat? YES | AddFactor 0.10
```
...
2. DISPUTED - The `baseCount <= 0` guard is safe for the intended town occupations. Vanilla town targets are `Merchant => 2`, `GangLeader => 2`, `Artisan => 1`; the only town occupations returning zero are the occupations DOTS maps to `Other` and should not inflate.
