...
Date: 2026-05-06  
Reviewer: Codex  
DOTS target version: Bannerlord 1.3.15  
...
A. SaveableType safety: BaseId is DOTS-unique and required containers exist. Findings: P2 save-order bug and P2 missing new-campaign reset.
...
public override void SyncData(IDataStore dataStore)
{
    try
    {
        dataStore.SyncData("DOTS_FormationPresets", ref _savedPresets);
