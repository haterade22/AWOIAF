...
The CRITICAL bug is a NEW pattern this repo has not hit before: **Write tool entity-encoding paths with `&`**. It is NOT a Bannerlord API issue, NOT a DOTS architecture issue, NOT a deep-review-scope gap — it's a harness/tool issue at the file-creation boundary.
...
- [Main/_Module/ModuleData/equipmentsets/dots_career_starting_equipment.xml](../../Main/_Module/ModuleData/equipmentsets/dots_career_starting_equipment.xml) — Horse/HorseHarness explicit clears added to ranged + infantry rosters
