...
- `Main/Features/DotsSettings.cs` lines 274-287 -- 3 MCM settings under group "Fief Management" GroupOrder=26
...
- Main/Features/DotsSettings.cs lines 274-287

Tests:
- DOTS.Tests/Features/FiefManagement/FiefHubServiceTests.cs
...
b. Compare each MCM hint text in DotsSettings.cs to actual code behavior. Flag any mismatch.
