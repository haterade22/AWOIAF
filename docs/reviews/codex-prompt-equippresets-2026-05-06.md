...
- `Main/Features/DotsSettings.cs` -- 3 properties at GroupOrder 33

### Tests
- `DOTS.Tests/Features/EquipPresets/EquipmentPresetServiceTests.cs`
- `DOTS.Tests/Features/EquipPresets/HoNEquipmentPresetTests.cs`
- `DOTS.Tests/Features/EquipPresets/PresetSaveableTypeDefinerTests.cs`
- `DOTS.Tests/Features/EquipPresets/EquipPresetsSettingsProviderTests.cs`
...
The MCM properties are in `Main/Features/DotsSettings.cs` lines ~373-388:
