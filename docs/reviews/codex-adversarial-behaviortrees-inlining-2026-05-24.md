...
- `~/.claude/projects/c--Users-mikew-source-repos-DOTS/memory/feedback_missionbehaviortype_logic_requires_missionlogic_inheritance.md`
...
Build note: I attempted `dotnet build Main/DOTS.csproj`, but the sandbox denied SDK access to `C:\Users\mikew\AppData\Local\Microsoft SDKs`, so this review is source/decompile based.
