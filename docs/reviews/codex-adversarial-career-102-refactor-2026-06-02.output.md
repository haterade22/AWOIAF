...
- `DOTS.Tests/Features/CareerSystem/AbilityActivationControllerTests.cs` — 12 unit tests
...
## Known Suspects (DOTS-historic class)
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "rg -n \"class CareerPerkMissionBehavior|class AbilityActivationController|class AbilityHudController|class AbilityEffectExecutor|interface IAbility|MissionAbilityExecutionContext|OnAgentDeleted|OnAgentRemoved|CareerSystemIoC|CreateGameModels|new CareerPerkMissionBehavior|Reuse\\.Singleton\" Main/Features/CareerSystem Main/SubModule.cs DOTS.Tests/Features/CareerSystem" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command 'rg --files Main/Features/CareerSystem DOTS.Tests/Features/CareerSystem | sort' in C:\Users\mikew\source\repos\DOTS
exec
...
[31;1mrg: [0m
[31;1m[36;1mLine |[0m
[31;1m[36;1m[36;1m   2 | [0m [36;1mrg[0m --files Main/Features/CareerSystem DOTS.Tests/Features/CareerSyste …[0m
...
?? DOTS.Tests/Features/CareerSystem/AbilityActivationControllerTests.cs
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CareerSystem/CareerPerkMissionBehavior.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CareerSystem/Abilities/AbilityActivationController.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CareerSystem/UI/AbilityHudController.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CareerSystem/Abilities/AbilityEffectExecutor.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 529ms:
   1: namespace DOTS.Features.CareerSystem.Abilities;
   2: 
 ...
 succeeded in 475ms:
   ...
   6: using DOTS.Features.CareerSystem.Abilities;
   7: 
   8: namespace DOTS.Features.CareerSystem.UI;
   9: 
 ...
 succeeded in 545ms:
   ...
   7: using DOTS.Features.CareerSystem.Abilities;
   8: using DOTS.Features.CareerSystem.UI;
   9: 
  10: namespace DOTS.Features.CareerSystem;
  11: 
 ...
 succeeded in 485ms:
   ...
   9: using DOTS.Features.CareerSystem.Domain;
  10: using DOTS.Features.CareerSystem.Mutations;
  11: 
  12: namespace DOTS.Features.CareerSystem.Abilities;
  13: 
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/SubModule.cs' | ForEach-Object { if ("'$i -ge 640 -and $i -le 710) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CareerSystem/CareerSystemIoC.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command 'git diff -- Main/Features/CareerSystem/CareerPerkMissionBehavior.cs Main/Features/CareerSystem/CareerSystemIoC.cs Main/SubModule.cs' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -LiteralPath 'Main/Features/CareerSystem/Abilities' -File | Select-Object -ExpandProperty FullName" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'DOTS.Tests/Features/CareerSystem/AbilityActivationControllerTests.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 374ms:
...
-using DOTS.Features.CareerSystem.Mutations;
...
+
         // Phase 9b #142 — agent-stat service extracted out of DotsAgentStatCalculateModel /
         // DotsAgentApplyDamageModel bodies (gamemodels.md rule 4 — no inline branching in
...
warning: in the working copy of 'Main/Features/CareerSystem/CareerPerkMissionBehavior.cs', LF will be replaced by CRLF the next time Git touches it
 ...
 succeeded in 499ms:
   ...
   4: using DOTS.Features.CareerSystem.Abilities;
   5: using DOTS.Features.CareerSystem.Abilities.Executors;
   6: using DOTS.Features.CareerSystem.Domain;
   7: using DOTS.Features.CareerSystem.Mutations;
   8: 
   9: namespace DOTS.Features.CareerSystem;
  10: 
  ...
  40: 
  41:         // Phase 9b #142 — agent-stat service extracted out of DotsAgentStatCalculateModel /
  42:         // DotsAgentApplyDamageModel bodies (gamemodels.md rule 4 — no inline branching in
 ...
 657: 
 658:         // MissionDiagnostic: added LAST so it sees all behaviors added by DOTS AND
 659:         // every other mod in the load chain. Dumps MissionBehaviors + MissionLogics
 660:         // on first OnMissionTick to dots_debug_*.log so user-uploaded crash logs
 ...
 676:         // DotsDevTriggerException on the next OnMissionTick when the player flips
 ...
 succeeded in 507ms:
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\AbilityActivationController.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\AbilityEffectExecutor.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\AbilityInputAdapter.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\ActiveBuffsAlgebra.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbility.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbilityBuffTracker.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbilityEffectRegistry.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbilityService.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAgentStatService.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\IAbilityActivationController.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\IAbilityEffectExecutor.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\IAbilityExecutionContext.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\IAbilityInputAdapter.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\ICareerAbilityEffectExecutor.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\ICareerAbilityService.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\ICareerAgentStatService.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\IMissionTimeProvider.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\MissionAbilityExecutionContext.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\MissionTimeProvider.cs

 succeeded in 512ms:
   1: using Microsoft.VisualStudio.TestTools.UnitTesting;
   2: using NSubstitute;
   3: using DOTS.Features.CareerSystem.Abilities;
   4: 
   5: namespace DOTS.Tests.Features.CareerSystem;
   6: 
   7: [TestClass]
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CareerSystem/Abilities/MissionAbilityExecutionContext.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CareerSystem/Abilities/CareerAbilityEffectRegistry.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CareerSystem/Abilities/AbilityInputAdapter.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CareerSystem/Abilities/CareerAbilityService.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CareerSystem/Abilities/MissionTimeProvider.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 497ms:
   1: using System;
   2: using System.Collections.Generic;
   3: using DOTS.Core.Logging;
   4: using TaleWorlds.Engine;
   5: using TaleWorlds.Library;
   6: using TaleWorlds.MountAndBlade;
   7: 
   8: namespace DOTS.Features.CareerSystem.Abilities;
   9: 
 ...
 succeeded in 487ms:
   ...
   3: using DOTS.Features.CareerSystem.Domain;
   4: 
   5: namespace DOTS.Features.CareerSystem.Abilities;
   6: 
 ...
 succeeded in 525ms:
   1: using System.Collections.Generic;
   2: 
   3: namespace DOTS.Features.CareerSystem.Abilities;
   4: 
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -LiteralPath 'E:\\Decompiled_Bannerlord' -Directory | Select-Object -First 30 -ExpandProperty FullName" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord' -Recurse -Filter 'Mission.cs' -ErrorAction SilentlyContinue | Select-Object -First 20 -ExpandProperty FullName" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord' -Recurse -Filter 'Input.cs' -ErrorAction SilentlyContinue | Select-Object -First 20 -ExpandProperty FullName" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord' -Recurse -Filter 'ScreenManager.cs' -ErrorAction SilentlyContinue | Select-Object -First 20 -ExpandProperty FullName" in C:\Users\mikew\source\repos\DOTS
 succeeded in 555ms:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -LiteralPath 'E:\\Decompiled_Bannerlord\\MountAndBlade\\TaleWorlds.MountAndBlade\\TaleWorlds.MountAndBlade\\Mission.cs' -Pattern 'void Tick|CurrentTime|OnMissionTick|TickAgentsAndTeams' -Context 3,8" in C:\Users\mikew\source\repos\DOTS
exec
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord' -Recurse -Filter 'GauntletLayer.cs' -ErrorAction SilentlyContinue | Select-Object -First 10 -ExpandProperty FullName" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -LiteralPath 'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.InputSystem\\TaleWorlds.InputSystem\\Input.cs' -Pattern 'IsKeyPressed|IsKeyDown|Update' -Context 2,6" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -LiteralPath 'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.ScreenSystem\\TaleWorlds.ScreenSystem\\ScreenManager.cs' -Pattern 'TopScreen|AddLayer|RemoveLayer|Tick' -Context 2,8" in C:\Users\mikew\source\repos\DOTS
 succeeded in 536ms:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\MountAndBlade\\TaleWorlds.MountAndBlade\\TaleWorlds.MountAndBlade\\Mission.cs' | ForEach-Object { if ("'$i -ge 1168 -and $i -le 1188) { '"'{0,5}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -LiteralPath 'E:\\Decompiled_Bannerlord\\MountAndBlade\\TaleWorlds.MountAndBlade\\TaleWorlds.MountAndBlade\\Mission.cs' -Pattern '_cachedMissionTime' -Context 2,4" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.InputSystem' -Recurse -Filter '*InputManager*.cs' -ErrorAction SilentlyContinue | Select-Object -ExpandProperty FullName" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.InputSystem\\TaleWorlds.InputSystem\\Input.cs' | ForEach-Object { if ("'$i -ge 184 -and $i -le 206) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\MountAndBlade\\TaleWorlds.MountAndBlade\\TaleWorlds.MountAndBlade\\Mission.cs' | ForEach-Object { if ("'$i -ge 3698 -and $i -le 3768) { '"'{0,5}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 537ms:
 1168: 
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.InputSystem\\TaleWorlds.InputSystem\\EmptyInputManager.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.InputSystem\\TaleWorlds.InputSystem\\IInputManager.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -Path 'E:\\Decompiled_Bannerlord\\**\\*.cs' -Pattern 'IsKeyPressed\\(' -ErrorAction SilentlyContinue | Select-Object -First 50" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord' -Recurse -Filter '*InputState*.cs' -ErrorAction SilentlyContinue | Select-Object -ExpandProperty FullName" in C:\Users\mikew\source\repos\DOTS
 succeeded in 512ms:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.InputSystem\\TaleWorlds.InputSystem\\InputState.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord' -Recurse -Filter '*.cs' -ErrorAction SilentlyContinue | Select-String -Pattern 'Input\\.IsKeyPressed|\\.IsPressed\\(|IsKeyPressed\\(' | Select-Object -First 80" in C:\Users\mikew\source\repos\DOTS
 succeeded in 476ms:
   1: using TaleWorlds.Library;
   2: 
   3: namespace TaleWorlds.InputSystem;
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.Engine.AutoGenerated\\ManagedCallbacks\\ScriptingInterfaceOfIInput.cs' | ForEach-Object { if ("'$i -ge 336 -and $i -le 356) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.Engine\\TaleWorlds.Engine.InputSystem\\EngineInputManager.cs' | ForEach-Object { if ("'$i -ge 100 -and $i -le 124) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.InputSystem\\TaleWorlds.InputSystem\\Key.cs' | ForEach-Object { if ("'$i -ge 38 -and $i -le 58) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.InputSystem\\TaleWorlds.InputSystem\\InputContext.cs' | ForEach-Object { if ("'$i -ge 140 -and $i -le 154) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.TwoDimension.Standalone\\TaleWorlds.TwoDimension.Standalone\\StandaloneInputManager.cs' | ForEach-Object { if ("'$i -ge 112 -and $i -le 140) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 520ms:
 100: 	{
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord' -Recurse -Filter '*GauntletMovie*.cs' -ErrorAction SilentlyContinue | Select-Object -ExpandProperty FullName" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.Engine.GauntletUI\\TaleWorlds.Engine.GauntletUI\\GauntletLayer.cs' | ForEach-Object { if ("'$i -ge 1 -and $i -le 160) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.ScreenSystem' -Recurse -Filter 'ScreenBase.cs' -ErrorAction SilentlyContinue | Select-Object -ExpandProperty FullName" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -Path 'E:\\Decompiled_Bannerlord\\**\\*.cs' -Pattern 'ReleaseMovie\\(|LoadMovie\\(' -ErrorAction SilentlyContinue | Select-Object -First 80" in C:\Users\mikew\source\repos\DOTS
 succeeded in 582ms:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.ScreenSystem\\TaleWorlds.ScreenSystem\\ScreenBase.cs' | ForEach-Object { if ("'$i -ge 1 -and $i -le 180) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.Engine.GauntletUI\\TaleWorlds.Engine.GauntletUI\\GauntletLayer.cs' | ForEach-Object { if ("'$i -ge 157 -and $i -le 230) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.ScreenSystem\\TaleWorlds.ScreenSystem\\ScreenLayer.cs' | ForEach-Object { if ("'$i -ge 1 -and $i -le 220) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\UI\\TaleWorlds.GauntletUI.Data\\TaleWorlds.GauntletUI.Data\\GauntletMovie.cs' | ForEach-Object { if ("'$i -ge 1 -and $i -le 140) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 556ms:
   1: using System.Collections.Generic;
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.ScreenSystem\\TaleWorlds.ScreenSystem\\ScreenBase.cs' | ForEach-Object { if ("'$i -ge 180 -and $i -le 270) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.ScreenSystem\\TaleWorlds.ScreenSystem\\ScreenManager.cs' | ForEach-Object { if ("'$i -ge 486 -and $i -le 528) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.ScreenSystem\\TaleWorlds.ScreenSystem\\ScreenManager.cs' | ForEach-Object { if ("'$i -ge 896 -and $i -le 924) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 527ms:
 180: 		}
 181: 	}
 182: 
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\Engine\\TaleWorlds.ScreenSystem\\TaleWorlds.ScreenSystem\\ScreenBase.cs' | ForEach-Object { if ("'$i -ge 268 -and $i -le 360) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord' -Recurse -Filter '*MissionScreen*.cs' -ErrorAction SilentlyContinue | Select-Object -First 20 -ExpandProperty FullName" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord' -Recurse -Filter '*MissionState*.cs' -ErrorAction SilentlyContinue | Select-Object -First 20 -ExpandProperty FullName" in C:\Users\mikew\source\repos\DOTS
 succeeded in 494ms:
 268: 	public void AddComponent(ScreenComponent component)
 269: 	{
 270: 		_components.Add(component);
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord' -Recurse -Filter '*.cs' -ErrorAction SilentlyContinue | Select-String -Pattern 'OnEndMission\\(|EndMissionInternal|OnMissionEnded|MissionEnded' | Select-Object -First 120" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\MountAndBlade\\TaleWorlds.MountAndBlade\\TaleWorlds.MountAndBlade\\MissionState.cs' | ForEach-Object { if ("'$i -ge 1 -and $i -le 260) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord' -Recurse -Filter '*MissionView*.cs' -ErrorAction SilentlyContinue | Select-Object -First 50 -ExpandProperty FullName" in C:\Users\mikew\source\repos\DOTS
 succeeded in 524ms:
   1: using System.Collections.Generic;
   2: using System.Linq;
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\MountAndBlade\\TaleWorlds.MountAndBlade\\TaleWorlds.MountAndBlade\\Mission.cs' | ForEach-Object { if ("'$i -ge 4548 -and $i -le 4592) { '"'{0,5}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\MountAndBlade\\TaleWorlds.MountAndBlade\\TaleWorlds.MountAndBlade\\MissionBehavior.cs' | ForEach-Object { if ("'$i -ge 110 -and $i -le 130) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\MountAndBlade\\TaleWorlds.MountAndBlade\\TaleWorlds.MountAndBlade\\MissionState.cs' | ForEach-Object { if ("'$i -ge 120 -and $i -le 130) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\MountAndBlade\\TaleWorlds.MountAndBlade\\TaleWorlds.MountAndBlade\\MissionState.cs' | ForEach-Object { if ("'$i -ge 246 -and $i -le 285) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 552ms:
 4548: 	}
 4549: 
 4550: 	[UsedImplicitly]
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\MountAndBlade\\TaleWorlds.MountAndBlade\\TaleWorlds.MountAndBlade\\MissionState.cs' | ForEach-Object { if ("'$i -ge 279 -and $i -le 326) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord' -Recurse -Filter '*.cs' -ErrorAction SilentlyContinue | Select-String -Pattern 'OpenNew\\(|PushState\\(.*MissionState|CreateState<MissionState>|MissionState.Open' | Select-Object -First 80" in C:\Users\mikew\source\repos\DOTS
 succeeded in 1504ms:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'Main\\Features\\CareerSystem\\Abilities','Main\\Features\\CareerSystem\\UI' -Filter '*.cs' | Select-String -Pattern 'new List|new Dictionary|\\.Where\\(|\\.Select\\(|=>.*new|Action<|Func<' | Select-Object Path,LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'Main\\Features\\CareerSystem' -Recurse -Filter '*.cs' | Select-String -Pattern 'LogInfo|LogDebug|LogWarning|DisplayMessage' | Select-Object Path,LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
 succeeded in 528ms:

[32;1mPath                                                                                                   [0m[32;1m LineNumber[0m[32;1m Line[0m
[32;1m----                                                                                                   [0m [32;1m----------[0m [32;1m----[0m
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\AbilityEffectExecutor.cs                  47    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\ActiveBuffsAlgebra.cs                     39    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbilityBuffTracker.cs                7    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbilityBuffTracker.cs                8    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbilityEffectRegistry.cs            10    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbilityService.cs                   11    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\IAbilityEffectExecutor.cs                 13    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\MissionAbilityExecutionContext.cs         20    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerChoiceObjectVM.cs                          11    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerChoiceObjectVM.cs                          12    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerChoiceObjectVM.cs                          20    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerChoiceObjectVM.cs                          21    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerChoiceObjectVM.cs                          43    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerChoiceObjectVM.cs                          46    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerScreenVM.cs                                54    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerScreenVM.cs                                71    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerSwitchTargetVM.cs                          14    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerSwitchTargetVM.cs                          16    …
...
[32;1mPath                                                                                                   [0m[32;1m LineNumber[0m[32;1m Line[0m
[32;1m----                                                                                                   [0m [32;1m----------[0m [32;1m----[0m
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs                           51    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs                           55    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs                           64    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs                           78    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs                           85    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs                           90    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs                           92    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs                          100    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs                          107    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs                          117    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs                             71    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs                             83    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs                             89    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs                             92    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs                            147    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs                            164    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs                            167    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs                            288    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs                            325    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs                            338    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs                            381    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs                            401    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs                            410    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs                            416    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs                            422    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs                            28    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs                            49    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPassiveService.cs                             39    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPassiveService.cs                             79    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPassiveService.cs                             87    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPassiveService.cs                            103    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPerkMissionBehavior.cs                        59    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPerkMissionBehavior.cs                        70    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPerkMissionBehavior.cs                        74    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPerkMissionBehavior.cs                        80    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPerkMissionBehavior.cs                       115    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPersistenceBehavior.cs                        26    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPersistenceBehavior.cs                        61    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPersistenceBehavior.cs                       119    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                        40    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                        47    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                        83    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                        88    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                        93    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                       100    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                       116    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                       146    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                       153    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                       162    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                       172    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                       184    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                       196    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                       203    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                       210    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                       219    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestConfigProvider.cs                       226    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestService.cs                               91    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestService.cs                               96    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestService.cs                              117    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerQuestService.cs                              145    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerRegistry.cs                                   71    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerRegistry.cs                                   76    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerRegistry.cs                                   82    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerRegistry.cs                                  100    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerRegistry.cs                                  105    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerRegistry.cs                                  171    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerSwitchDialogueBehavior.cs                     83    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerSwitchService.cs                              29    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerSwitchService.cs                              43    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerSwitchService.cs                              49    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerSwitchService.cs                              57    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerSwitchService.cs                              63    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerSwitchService.cs                              75    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\AbilityEffectExecutor.cs                  70    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbilityService.cs                   27    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbilityService.cs                   34    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbilityService.cs                   47    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbilityService.cs                   72    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbilityService.cs                   76    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\MissionAbilityExecutionContext.cs         68    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\MissionAbilityExecutionContext.cs        171    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Mutations\MutationCalculatorRegistry.cs             28    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Mutations\MutationService.cs                        79    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Mutations\MutationService.cs                        85    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuest.cs                              102    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuest.cs                              108    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuest.cs                              224    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuestCampaignBehavior.cs              104    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuestCampaignBehavior.cs              116    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\AbilityHudController.cs                          55    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerScreenVM.cs                               182    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerScreenVM.cs                               196    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerScreenVM.cs                               269    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CharacterDeveloperCareerMixin.cs                 41    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CharacterDeveloperCareerMixin.cs                 60    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                          61    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                          66    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                          70    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                          88    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                         108    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                         115    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                         117    …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                         134    …
...
[32;1mPath[0m
[32;1m----                                                                                                                   [0m
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs                                  
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs                                  
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPassiveService.cs                                    
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPassiveService.cs                                    
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPerkMissionBehavior.cs                               
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPerkMissionBehavior.cs                               
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPerkMissionBehavior.cs                               
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPerkMissionBehavior.cs                               
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPerkMissionBehavior.cs                               
...
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPerkMissionBehavior.cs                               
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPerkMissionBehavior.cs                               
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerPersistenceBehavior.cs                               
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerSwitchDialogueBehavior.cs                            
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\ICareerPassiveService.cs                                   
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\AbilityActivationController.cs                   
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\AbilityEffectExecutor.cs                         
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\AbilityEffectExecutor.cs                         
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\AbilityEffectExecutor.cs                         
...
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\MissionTimeProvider.cs                           
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\MissionTimeProvider.cs                           
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Hooks\Patch27_CareerSystem\ViewModel_ExecuteCommand_Career…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Hooks\Patch27_CareerSystem\ViewModel_ExecuteCommand_Career…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Models\DotsAgentApplyDamageModel.cs                        
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Models\DotsAgentApplyDamageModel.cs                        
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Models\DotsAgentApplyDamageModel.cs                        
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Models\DotsAgentStatCalculateModel.cs                      
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Models\DotsAgentStatCalculateModel.cs                      
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Models\DotsClanTierModel.cs                                
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Models\DotsClanTierModel.cs                                
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Models\DotsInventoryCapacityModel.cs                       
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Models\DotsInventoryCapacityModel.cs                       
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Models\DotsInventoryCapacityModel.cs                       
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Models\DotsMapVisibilityModel.cs                           
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Models\DotsMapVisibilityModel.cs                           
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Models\DotsMapVisibilityModel.cs                           
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuest.cs                                      
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuest.cs                                      
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuest.cs                                      
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuest.cs                                      
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuest.cs                                      
...
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuest.cs                                      
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuest.cs                                      
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuestCampaignBehavior.cs                      
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuestCampaignBehavior.cs                      
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuestCampaignBehavior.cs                      
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuestCampaignBehavior.cs                      
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuestCampaignBehavior.cs                      
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Quests\CareerQuestSaveableTypeDefiner.cs                   
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\AbilityHudController.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\AbilityHudController.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\AbilityHudController.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\AbilityHudController.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\AbilityHudController.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\AbilityHudController.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\AbilityHudController.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerAbilityEffectVM.cs                                
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerAbilityHudVM.cs                                   
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerChoiceGroupObjectVM.cs                            
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerChoiceGroupObjectVM.cs                            
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerChoiceObjectVM.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerChoiceObjectVM.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerScreenGameState.cs                                
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerScreenVM.cs                                       
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerScreenVM.cs                                       
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerSwitchTargetVM.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerSwitchTargetVM.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CharacterDeveloperCareerMixin.cs                        
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CharacterDeveloperCareerMixin.cs                        
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CharacterDeveloperCareerMixin.cs                        
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                                 
...
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                                 
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\IAbilityHudController.cs                                
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\IAbilityHudController.cs                                


exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CareerSystem/Abilities/ICareerAbilityEffectExecutor.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -LiteralPath 'Main/Features/CareerSystem/Abilities/Executors' -Filter '*.cs' | ForEach-Object { "'$_.FullName }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -LiteralPath 'Main/Features/CareerSystem/Abilities/Executors' -Filter '*.cs' | Select-String -Pattern 'TaleWorlds|Agent|Mission|Campaign|CharacterObject|Input|ScreenManager|InformationManager' | Select-Object Path,LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
 ...
 succeeded in 530ms:
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\Executors\CavalryAbilityExecutor.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\Executors\InfantryAbilityExecutor.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\Executors\RangedAbilityExecutor.cs
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CareerSystem/Abilities/CareerAbilityBuffTracker.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CareerSystem/Abilities/IAbilityExecutionContext.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 535ms:
   1: using System.Collections.Generic;
   2: 
   3: namespace DOTS.Features.CareerSystem.Abilities;
 ...
 succeeded in 559ms:
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\Executors\CavalryAbilityExecutor.cs:15:     public void Execute(IAbilityExecutionContext context)
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\Executors\CavalryAbilityExecutor.cs:21:         context.ApplyAllyCavalryBuff(
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\Executors\CavalryAbilityExecutor.cs:25:             radius: context.Radius,
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\Executors\CavalryAbilityExecutor.cs:26:             duration: context.Duration);
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\Executors\InfantryAbilityExecutor.cs:15:     public void Execute(IAbilityExecutionContext context)
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\Executors\InfantryAbilityExecutor.cs:19:         // Use context.Radius (from mutated ability template) so choice-tree radius upgrades apply
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\Executors\InfantryAbilityExecutor.cs:20:         context.ApplyAllyBuff(tuning.DamageBonus / 100f, tuning.DamageReduction / 100f, context.Radius, context.Duration);
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\Executors\RangedAbilityExecutor.cs:15:     public void Execute(IAbilityExecutionContext context)
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\Executors\RangedAbilityExecutor.cs:21:         context.ApplyAllyRangedBuff(
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\Executors\RangedAbilityExecutor.cs:25:             radius: context.Radius,
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\Executors\RangedAbilityExecutor.cs:26:             duration: context.Duration);
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CareerSystem/Abilities/CareerAbility.cs' | ForEach-Object { '{0,4}: {1}' -f "'$i++, $_ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'Main\\Features\\CareerSystem' -Recurse -Filter '*.cs' | Select-String -Pattern 'SetCareer|SwitchCareer|AssignCareer|_career|career' | Select-Object -First 120 Path,LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
 succeeded in 473ms:
   1: using System;
   2: using DOTS.Features.CareerSystem.Domain;
   3: 
   4: namespace DOTS.Features.CareerSystem.Abilities;
   5: 
...
[32;1mPath                                                                                 [0m[32;1m LineNumber[0m[32;1m Line[0m
[32;1m----                                                                                 [0m [32;1m----------[0m [32;1m----[0m
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerArchetypeService.cs          2 using DOTS.Features.C…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerArchetypeService.cs          4 namespace DOTS.Featur…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerArchetypeService.cs          6 public sealed class C…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerArchetypeService.cs          8     private readonly …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerArchetypeService.cs         10     public CareerArch…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerArchetypeService.cs         12         _careerArchet…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerArchetypeService.cs         15     public bool TryGe…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerArchetypeService.cs         17         if (string.Is…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerArchetypeService.cs         22         return _caree…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs          4 using DOTS.Features.C…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs          6 namespace DOTS.Featur…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs          8 public class CareerCa…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         10     private readonly …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         11     private readonly …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         12     private readonly …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         13     private readonly …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         14     private readonly …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         17     public CareerCamp…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         18         ICareerDataSe…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         19         ICareerRegist…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         20         ICareerPassiv…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         21         ICareerCreati…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         22         ICareerAbilit…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         48         // player), s…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         51         _logger.LogIn…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         55             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         59         // Legacy sav…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         60         // (New games…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         61         if (!_dataSer…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         64             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         67                 forea…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         70                     f…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         77                      …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         78                      …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         85         _logger.LogIn…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         88         var careerId …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         89         if (careerId …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         90             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         92             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs         98         if (!_dataSer…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs        100             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs        107             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs        115         if (_dataServ…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs        117             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCampaignBehavior.cs        118             _dataServ…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs            8 using DOTS.Features.C…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           10 namespace DOTS.Featur…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           12 public class CareerCo…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           17     private List<Care…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           18     private List<Care…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           19     private List<Care…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           24     public CareerConf…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           30     public IReadOnlyL…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           33         return _caree…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           36     public IReadOnlyL…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           42     public IReadOnlyL…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           69         if (_careers …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           71         _logger.LogIn…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           73         _careers = ne…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           74         _groups = new…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           75         _choices = ne…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           78         LoadCareersXm…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           83         _logger.LogIn…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           86     private void Load…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           88         var path = Pa…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           89         _logger.LogIn…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs           92             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          104             foreach (…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          132                     v…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          146                     _…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          147                     _…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          151                     _…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          157             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          163         var path = Pa…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          164         _logger.LogIn…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          167             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          201                     v…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          203                      …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          212                     _…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          218             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          222     private CareerCho…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          267             return ne…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          278             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          285         var path = Pa…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          288             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          321                     _…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          325             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          329             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          335         var path = Pa…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          338             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          381             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          385             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          401             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          406         // (NaN compa…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          410             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          416             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          422             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerConfigProvider.cs          442         // (Career #3…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs           3 namespace DOTS.Featur…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs           5 public class CareerCr…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs           7     private readonly …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs           8     private readonly …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs           9     private readonly …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs          12     public CareerCrea…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs          13         ICareerDataSe…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs          14         ICareerRegist…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs          15         ICareerPassiv…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs          24     public void OnCar…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs          26         if (string.Is…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs          28             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs          32         var career = …
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs          33         if (career ==…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs          35             _logger.L…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs          39         _dataService.…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs          42         if (!string.I…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs          45             _dataServ…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerCreationHandler.cs          49         _logger.LogIn…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerDataService.cs               2 using DOTS.Features.C…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerDataService.cs               4 namespace DOTS.Featur…
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\CareerDataService.cs               6 public class CareerDa…
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "if (Test-Path -LiteralPath 'docs/reviews/REVIEW-GUIDE.md') { "'$i=1; Get-Content -LiteralPath '"'docs/reviews/REVIEW-GUIDE.md' | ForEach-Object { if ("'$i -le 220) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ } }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'docs\\reviews' -Filter '*career*102*' | Select-Object Name,Length,LastWriteTime" in C:\Users\mikew\source\repos\DOTS
 succeeded in 517ms:
  ...
  91: 
  92: DOTS ID CHEATSHEET (prevents false positives from ID confusion):
 ...
 130:   b) {specific question about how DOTS interacts with vanilla}
 ...
 143: -- Culture IDs: check against dots_spcultures.xml + spcultures.xslt
 144: -- Kingdom IDs: check against DOTS_spkingdoms.xml
 ...
 177: - Garrison wage gate found by comparing DOTS vs vanilla IsGarrison (TroopProgression)
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -Path 'Main\\**\\*.cs' -Pattern 'OnRemoveBehavior|RemoveBehavior' -ErrorAction SilentlyContinue | Select-Object Path,LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\MountAndBlade\\TaleWorlds.MountAndBlade\\TaleWorlds.MountAndBlade\\MissionBehavior.cs' | ForEach-Object { if ("'$i -ge 130 -and $i -le 145) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 519ms:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\MountAndBlade\\TaleWorlds.MountAndBlade\\TaleWorlds.MountAndBlade\\Mission.cs' | ForEach-Object { if ("'$i -ge 2203 -and $i -le 2225) { '"'{0,5}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -LiteralPath 'E:\\Decompiled_Bannerlord\\MountAndBlade\\TaleWorlds.MountAndBlade\\TaleWorlds.MountAndBlade\\MissionBehavior.cs' -Pattern 'OnMissionStateFinalized|OnAfterMissionCreated|Mission =' -Context 2,4" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'E:\\Decompiled_Bannerlord\\MountAndBlade\\TaleWorlds.MountAndBlade\\TaleWorlds.MountAndBlade\\Mission.cs' | ForEach-Object { if ("'$i -ge 4628 -and $i -le 4650) { '"'{0,5}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 580ms:
...
codex
No DOTS `OnRemoveBehavior` override exists for this behavior. Vanilla normal finalization does remove behaviors after `OnEndMission`, but the singleton cleanup depends on the `OnEndMission` path, not `OnRemoveBehavior`. I’m treating that as acceptable for normal mission lifecycle unless I find a concrete skip path.
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command 'dotnet test DOTS.Tests --filter AbilityActivationControllerTests --no-restore' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'Main\\Features\\CareerSystem\\Abilities','Main\\Features\\CareerSystem\\UI' -Filter '*.cs' | ForEach-Object { "'$lines = (Get-Content -LiteralPath $_.FullName).Count; '"'{0}: {1}' -f "'$_.FullName, $lines }' in C:\Users\mikew\source\repos\DOTS
...
System.UnauthorizedAccessException: Access to the path 'C:\Users\CodexSandboxOffline\.dotnet\10.0.300.toolpath.sentinel' is denied.
 ...
 succeeded in 471ms:
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\AbilityActivationController.cs: 75
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\AbilityEffectExecutor.cs: 90
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\AbilityInputAdapter.cs: 8
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\ActiveBuffsAlgebra.cs: 50
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbility.cs: 60
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbilityBuffTracker.cs: 38
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbilityEffectRegistry.cs: 27
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAbilityService.cs: 84
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\CareerAgentStatService.cs: 129
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\IAbilityActivationController.cs: 23
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\IAbilityEffectExecutor.cs: 14
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\IAbilityExecutionContext.cs: 16
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\IAbilityInputAdapter.cs: 9
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\ICareerAbilityEffectExecutor.cs: 7
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\ICareerAbilityService.cs: 13
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\ICareerAgentStatService.cs: 48
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\IMissionTimeProvider.cs: 8
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\MissionAbilityExecutionContext.cs: 208
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Abilities\MissionTimeProvider.cs: 8
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\AbilityHudController.cs: 115
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerAbilityEffectVM.cs: 27
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerAbilityHudVM.cs: 93
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerButtonPrefab.cs: 33
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerChoiceGroupObjectVM.cs: 171
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerChoiceObjectVM.cs: 107
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerScreenGameState.cs: 13
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerScreenVM.cs: 578
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CareerSwitchTargetVM.cs: 52
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\CharacterDeveloperCareerMixin.cs: 69
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs: 155
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\IAbilityHudController.cs: 18
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$env:DOTNET_CLI_HOME='"'C:\\tmp\\dotnet-cli-home'; "'$env:DOTNET_SKIP_FIRST_TIME_EXPERIENCE='"'1'; dotnet test DOTS.Tests --filter AbilityActivationControllerTests --no-restore" in C:\Users\mikew\source\repos\DOTS
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "New-Item -ItemType Directory -Force -Path '.dotnet-cli-home' | Out-Null; "'$env:DOTNET_CLI_HOME=(Resolve-Path '"'.dotnet-cli-home').Path; "'$env:DOTNET_SKIP_FIRST_TIME_EXPERIENCE='"'1'; dotnet test DOTS.Tests --filter AbilityActivationControllerTests --no-restore" in C:\Users\mikew\source\repos\DOTS
...
codex
I have one confirmed API-semantics mismatch: v1.4.5 `OnMissionTick(dt)` is not guaranteed to be one wall-clock frame delta. Before finalizing severity, I’m comparing vanilla/DOTS Gauntlet teardown patterns so I don’t turn a harmless redundant `ReleaseMovie` into a false positive.
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord' -Recurse -Filter '*.cs' -ErrorAction SilentlyContinue | Select-String -Pattern 'ReleaseMovie\\(' | Select-Object -First 120 Path,LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'E:\\Decompiled_Bannerlord' -Recurse -Filter '*.cs' -ErrorAction SilentlyContinue | Select-String -Pattern 'RemoveLayer\\(.*\\);' | Select-Object -First 120 Path,LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Path 'Main' -Recurse -Filter '*.cs' | Select-String -Pattern 'ReleaseMovie\\(|RemoveLayer\\(' | Select-Object Path,LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
 succeeded in 568ms:
...
[32;1m                                                                                                                   [0m[32;1m   r[0m
[32;1m----                                                                                                               [0m [32;1m---[0m
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\AbilityHudController.cs                               87
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\AbilityHudController.cs                               90
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\UI\GauntletCareerScreen.cs                              137
C:\Users\mikew\source\repos\DOTS\Main\Features\CompanionTactics\BattleActionBar\Hooks\BattleActionBarMissionView.cs  98
C:\Users\mikew\source\repos\DOTS\Main\Features\CompanionTactics\FormationPresets\OOBOverlayService.cs                94
C:\Users\mikew\source\repos\DOTS\Main\Features\EquipPresets\Hooks\Patch33_GauntletInventoryScreen.cs                 90
C:\Users\mikew\source\repos\DOTS\Main\Features\FactionMap\Hooks\CultureStageViewCreatedHook.cs                       90
C:\Users\mikew\source\repos\DOTS\Main\Features\FiefManagement\UI\GauntletFiefManagementScreen.cs                     87
...
codex
The local decompiled vanilla tree does not show feature-level `ReleaseMovie` patterns beyond `GauntletLayer` itself. DOTS sibling screens mostly call `RemoveLayer`/`ReleaseMovie` in their own wrappers; I’m checking those only for consistency, not as vanilla evidence.
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CareerSystem/UI/GauntletCareerScreen.cs' | ForEach-Object { if ("'$i -ge 120 -and $i -le 150) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CompanionTactics/BattleActionBar/Hooks/BattleActionBarMissionView.cs' | ForEach-Object { if ("'$i -ge 80 -and $i -le 108) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/CompanionTactics/FormationPresets/OOBOverlayService.cs' | ForEach-Object { if ("'$i -ge 80 -and $i -le 104) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content -LiteralPath '"'Main/Features/FiefManagement/UI/GauntletFiefManagementScreen.cs' | ForEach-Object { if ("'$i -ge 74 -and $i -le 96) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 549ms:
 120:     }
 121: 
...
1. LOW [Main/Features/CareerSystem/Abilities/AbilityActivationController.cs](</C:/Users/mikew/source/repos/DOTS/Main/Features/CareerSystem/Abilities/AbilityActivationController.cs:37>) — Vanilla API semantics — `dt` is documented/treated as “per-frame” wall-clock cooldown time, but v1.4.5 can pass simulation/fixed/fast-forward deltas.
...
2. MED [Main/Features/CareerSystem/UI/AbilityHudController.cs](</C:/Users/mikew/source/repos/DOTS/Main/Features/CareerSystem/UI/AbilityHudController.cs:85>) — HUD lifecycle ownership — `Cleanup()` removes `_hudLayer` from `ScreenManager.TopScreen`, not from the screen it was added to.

Evidence from vanilla:
`ScreenManager.PushScreen` changes `TopScreen` to the last screen in the stack. `ScreenBase.RemoveLayer(layer)` does not verify ownership; it calls `layer.HandleFinalize()` before `_layers.Remove(layer)`. So if a pause/modal/battle-result screen is top when mission cleanup runs, DOTS can finalize the HUD layer through the wrong screen and leave a finalized layer in the owning mission screen’s layer list.
...
I attempted `dotnet test DOTS.Tests --filter AbilityActivationControllerTests --no-restore`, but MSBuild was blocked by sandbox access to `C:\Users\mikew\AppData\Local\Microsoft SDKs`.
