...
# DOTS ID CHEATSHEET (for cross-reference)
...
NOTE: shaghana and abanissa are full INDEPENDENT KINGDOMS in the Harad region (registered in dots_spkingdoms.xml with their own ruler titles Taskral / Châjaphân, banner keys, settlements). They are NOT Aserai sub-cultures. They have NPC clans + lords (Shaghana 9 lords, Abanissa 8 lords).
...
- Main/_Module/ModuleData/dots_spkingdoms.xml (kingdom registrations - confirms shaghana/abanissa as kingdoms)
...
2. Youth menu step has NO DOTS options for shaghana (no string_id starting with dots_youth_shaghana_*). What does the CC menu actually show? Vanilla aserai options? Empty list? Crash?
...
- Memory files at C:\Users\mikew\.claude\projects\c--Users-mikew-source-repos-DOTS\memory\
...
- "Bug B (sturgia retainer) - Changed dots_youth_sturgia_1 title_type to guard" - confirm in youth_menu.json line 821.
