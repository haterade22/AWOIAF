...
1. **PARTIAL** — The prompt’s capital-G `Gundabad` examples are fixed in the current tree: `dots_spcultures.xml:4516/4538/4712/4875/4897/5071` and `dots_module_strings.xml:2193-2263` now use Goblin/Misty Mountain wording. Remaining complete display leftovers:
   ...
   - I found no new-faction `Gundabad` display leftovers in `dots_wanderers.xml`, new clans/lords/heroes, new equipmentsets, or factionmap. Preserved `Item.wm_gundabad_*`, `BodyProperty.fighter_gundabad`, and `SkillSet.spc_wanderer_gundabad` are intentional.
...
3. **DISPUTED** — Cultural feat wiring and dispatch are correct. The 8 new feats are present in fields/properties/register/init/yield paths (`DotsCulturalFeats.cs:78-86`, `224-232`, `372-380`, `644-676`, `960-967`), XML (`dots_spcultures.xml:4729-4732`, `5088-5091`), and dispatch (`CulturalFeatsService.cs:65-72`, `93-94`, `243-246`, `271-272`, `363-366`). `-0.4f` army cost produces `baseCost * 0.6`; food `+0.2/+0.15` increases consumption.
...
New kingdoms resolve: `goblin` -> `Culture.goblin` (`dots_spkingdoms.xml:910-918`), `mistymountainorcs` -> `Culture.mistymountainorcs` (`1014-1022`), `bluecraig` -> `Culture.goblin` (`1118-1126`), `lindon` -> `Culture.rivendell` (`1222-1229`). Owners resolve to existing heroes.
