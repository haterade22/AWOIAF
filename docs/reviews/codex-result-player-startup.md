...
- A 5-agent Claude `/deep-review` already ran. It surfaced four fixes, all applied:
  ...
  2. Changed `dots_youth_sturgia_1` `title_type` from `"retainer"` to `"guard"` (no vanilla `sturgia_retainer` roster exists).
...
- `DOTS.Tests/Features/StartupResources/PlayerStartupGoldServiceTests.cs` — 8 cases
- `DOTS.Tests/Features/CharacterCreation/PlayerEquipmentServiceTests.cs` — 9 cases
...
- `DOTS.Tests/Features/StartupResources/StartupResourcesConfigProviderTests.cs` — 5 new validation tests.
- `DOTS.Tests/Features/CharacterCreation/CharacterCreationContentServiceTests.cs` — constructor signature update.
...
- `Main/_Module/ModuleData/charactercreation/youth_menu.json` — `dots_youth_sturgia_1` `title_type` retainer→guard.
...
11. **youth_menu.json sturgia_1 title_type semantic shift:** Does anything else read `dots_youth_sturgia_1` and depend on `title_type == "retainer"`? Search localization keys, save-game upgrade paths, conditional logic in `CareerMenuService`, `NarrativeDataProvider`, etc. The change from retainer→guard might silently flip behavior elsewhere.

12. **Per-culture tier balance:** The seeded values are tunable but Mordor at 6000 + a high-yield raid economy = potential snowball. Sanity-check the values against DOTS's RaidModel + ClanFinanceModel modifiers for those cultures. Note any culture whose 4000–10000 starting gold combined with culture-specific feats produces a runaway start.
...
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command 'git status --short' in C:\Users\mikew\source\repos\DOTS
 ...
 M DOTS.Tests/Features/CharacterCreation/CharacterCreationContentServiceTests.cs
 M DOTS.Tests/Features/StartupResources/StartupResourcesConfigProviderTests.cs
...
?? DOTS.Tests/Features/CharacterCreation/PlayerEquipmentServiceTests.cs
?? DOTS.Tests/Features/Messengers/
?? DOTS.Tests/Features/SiegeDismount/
?? DOTS.Tests/Features/StartupResources/PlayerStartupGoldServiceTests.cs
?? docs/features/siege-dismount.md
?? docs/reviews/codex-prompt-player-startup.md
?? docs/reviews/codex-result-player-startup.md

exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Recurse -File .claude\\rules | Select-Object -ExpandProperty FullName" in C:\Users\mikew\source\repos\DOTS
 succeeded in 448ms:
C:\Users\mikew\source\repos\DOTS\.claude\rules\adapters.md
C:\Users\mikew\source\repos\DOTS\.claude\rules\csharp-architecture.md
C:\Users\mikew\source\repos\DOTS\.claude\rules\csharp-patterns.md
C:\Users\mikew\source\repos\DOTS\.claude\rules\environment-failures.md
C:\Users\mikew\source\repos\DOTS\.claude\rules\external-skill-ports.md
C:\Users\mikew\source\repos\DOTS\.claude\rules\gamemodels.md
C:\Users\mikew\source\repos\DOTS\.claude\rules\gui-ui.md
C:\Users\mikew\source\repos\DOTS\.claude\rules\harmony-patches.md
C:\Users\mikew\source\repos\DOTS\.claude\rules\harness-facts.md
C:\Users\mikew\source\repos\DOTS\.claude\rules\tests.md
C:\Users\mikew\source\repos\DOTS\.claude\rules\troops.md
C:\Users\mikew\source\repos\DOTS\.claude\rules\xml-data.md
C:\Users\mikew\source\repos\DOTS\.claude\rules\xslt.md

exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-Content .claude\\rules\\*.md" in C:\Users\mikew\source\repos\DOTS
 succeeded in 481ms:
---
paths:
  - "Main/Adapters/**"
...
# DOTS Architecture Quick Reference
...
**Doc requirement:** When documenting "edit this file to retune," state the reload scope explicitly. `Reuse.Singleton` providers (the DOTS default) cache for the entire Bannerlord process — changes require a full application restart, not a new campaign or save-load. Never claim "next game load" without cross-checking the DryIoc lifetime.
...
**Test requirement:** when fixing a finding of this class, add a regression test where the lookup returns the fallback value and assert the caller rejects the input. Example: `SetPlayerRace_InvalidFaceGenRaceId_DoesNotPreserve_FallsBackToCultureDefault` ([CharacterCreationContentServiceTests.cs](../../DOTS.Tests/Features/CharacterCreation/CharacterCreationContentServiceTests.cs)).
...
├── Models/
│   └── DotsMyModel.cs       ← GameModel override (if needed)
└── Hooks/
    └── MyPatch.cs           ← Harmony patch (if needed)
Main/Adapters/
├── IMyTypeAdapter.cs
└── MyTypeAdapter.cs
DOTS.Tests/Features/MyFeature/
...
public class DotsFooModel : DefaultFooModel
{
    ...
    public DotsFooModel(IFooService service) => _service = service;
...
DOTS uses manual `List<CodeInstruction>` iteration. Harmony 2.4.2 (Bannerlord 1.3) has an expanded `CodeMatcher` API — evaluate it for new transpilers before defaulting to manual iteration.
...
- A C# build error in DOTS source — fix per `/build-fix`
...
The line: anything inside the DOTS repo's tracked files is in scope. Anything outside (tools on PATH, env vars, Steam install, MCP servers, OS config) is the user's domain.
...
| Upstream field | DOTS disposition | Reason |
|---|---|---|
...
2. **Verify hook command paths.** The upstream may use a path like `~/.gstack/...` or `${CLAUDE_PLUGIN_DATA}/...` — these don't exist in DOTS. Use `${CLAUDE_PROJECT_DIR}/.claude/skills/<skill>/<script>.sh` for project-local scripts.
...
1. **Read `Main/_Module/GUI/DOTSSpriteData.xml`** — find the `<Name>` entry for your sprite
2. **Use the EXACT registered name** — sprite ID = filename without extension, prefixed by subfolder path using backslashes
3. **Do NOT add module prefixes** — a PNG at `SpriteParts/ui_taom/CareerSystem/foo.png` is `CareerSystem\foo`, NOT `DOTS\CareerSystem\foo`
4. **Verify the PNG exists** — check `GUI/SpriteParts/ui_taom/<subfolder>/` before referencing

**Why:** Sprite="DOTS\CareerSystem\career_button_placeholder" failed silently (blank button, no crash, no log) because the registered name was "CareerSystem\career_button_placeholder". This class of bug is invisible without in-game testing.
...
or from a specific DOTS bug we shipped and fixed. When you see "verified
...
This file is the source of truth for harness behavior in DOTS. Update the "Last verified" date and add new facts whenever a Codex review or experiment confirms something not yet captured here.
---
paths:
  - "DOTS.Tests/**"
  - "**/*Tests.cs"
...
## Test Organization
Mirror source structure: `DOTS.Tests/Features/{FeatureName}/{ServiceName}Tests.cs`
---
paths:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command 'git diff --stat; git diff --cached --stat' in C:\Users\mikew\source\repos\DOTS
 succeeded in 349ms:
 CHANGELOG.md                                       | 86 ++++++++++++++++++++++
 ...
 Main/Features/DotsSettings.cs                      | 39 ++++++++++
 Main/IoC.cs                                        |  2 +
 Main/SubModule.cs                                  |  2 +
...
warning: in the working copy of 'DOTS.Tests/Features/StartupResources/StartupResourcesConfigProviderTests.cs', LF will be replaced by CRLF the next time Git touches it
...
@@ -10,6 +10,7 @@ using DOTS.Adapters;
 using DOTS.Core.Domain;
...
@@ -11,6 +11,8 @@ namespace DOTS.Features.StartupResources;
...
@@ -171,4 +171,43 @@ public class DotsSettings : AttributeGlobalSettings<DotsSettings>
...
--- a/Main/IoC.cs
+++ b/Main/IoC.cs
@@ -31,6 +31,7 @@ using DOTS.Features.CareerSystem;
...
--- a/Main/SubModule.cs
+++ b/Main/SubModule.cs
@@ -59,6 +59,7 @@ using DOTS.Features.CareerSystem.Models;
 using DOTS.Features.SettlementGuards;
...
namespace DOTS.Features.StartupResources.Config;
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content Main'"\\Features\\CharacterCreation\\CharacterCreationContentService.cs | ForEach-Object { '{0,4}: {1}' -f "'$i, $_; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 448ms:
   1: using System;
   ...
   9: using DOTS.Adapters;
  10: using DOTS.Core.Domain;
  11: using DOTS.Core.Logging;
  12: using DOTS.Features.CharacterCreation.Models;
  13: using DOTS.Features.StartupResources;
  14: 
  15: namespace DOTS.Features.CharacterCreation;
  16: 
 ...
 130: 
 131:         _logger.LogInfo($"[{menuId}] Added {added} DOTS narrative options");
 132:     }
 133: 
 ...
 137:             .Where(o => !o.StringId.StartsWith("dots_", StringComparison.OrdinalIgnoreCase))
 138:             .ToList();
 139: 
...
[7m[0m  Main\Features\CharacterCreation\ICharacterCreationContentService.cs:11:}[0m
  Main\Features\CharacterCreation\DotsCharacterCreationContentHandler.cs:25:    public void 
AfterInitializeContent(CharacterCreationManager characterCreationManager)
  Main\Features\CharacterCreation\DotsCharacterCreationContentHandler.cs:26:    {
> Main\Features\CharacterCreation\DotsCharacterCreationContentHandler.cs:27:        
_contentService.[7mRegisterCustomCultures[0m(characterCreationManager);[0m
[7m [0m[7m [0m[7m[0mMain\Features\CharacterCreation\DotsCharacterCreationContentHandler.cs:28: [0m[7m [0m[7m [0m[7m [0m[7m [0m[7m [0m[7m [0m[7m [0m
[7m[0m_contentService.RegisterNarrativeMenus(characterCreationManager);[0m
[7m [0m[7m [0m[7m[0mMain\Features\CharacterCreation\DotsCharacterCreationContentHandler.cs:29: [0m[7m [0m[7m [0m[7m [0m[7m [0m[7m [0m[7m [0m[7m [0m
[7m[0m_contentService.RegisterCareerMenu(characterCreationManager);[0m
  Main\Features\CharacterCreation\DotsCharacterCreationContentHandler.cs:36:    }
  Main\Features\CharacterCreation\DotsCharacterCreationContentHandler.cs:37:
> Main\Features\CharacterCreation\DotsCharacterCreationContentHandler.cs:38:    public void 
[7mOnCharacterCreationFinalize[0m(CharacterCreationManager [0m[7m[0mcharacterCreationManager)[0m
[7m[0m  Main\Features\CharacterCreation\DotsCharacterCreationContentHandler.cs:39:    {[0m
> Main\Features\CharacterCreation\DotsCharacterCreationContentHandler.cs:40:        
_contentService.[7mOnCharacterCreationFinalize[0m(characterCreationManager);[0m
[7m[0m  Main\Features\CharacterCreation\DotsCharacterCreationContentHandler.cs:41:    }[0m
[7m[0m  Main\Features\CharacterCreation\DotsCharacterCreationContentHandler.cs:42:}[0m


exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-Content DOTS.Tests\\Features\\StartupResources\\PlayerStartupGoldServiceTests.cs,DOTS.Tests\\Features\\CharacterCreation\\PlayerEquipmentServiceTests.cs,DOTS.Tests\\Features\\StartupResources\\StartupResourcesConfigProviderTests.cs" in C:\Users\mikew\source\repos\DOTS
 succeeded in 456ms:
using System.Collections.Generic;
...
namespace DOTS.Tests.Features.StartupResources;
...
public class StartupResourcesConfigProviderTests
{
    ...
    public void Setup()
    {
        _tempDir = Path.Combine(Path.GetTempPath(), "DOTS_Tests_" + Path.GetRandomFileName());
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Recurse -File Main\\Features\\Messengers,Main\\Features\\SiegeDismount,DOTS.Tests\\Features\\Messengers,DOTS.Tests\\Features\\SiegeDismount | Select-Object FullName" in C:\Users\mikew\source\repos\DOTS
 succeeded in 439ms:

[32;1mFullName[0m
[32;1m--------[0m
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\IMessengerConfigProvider.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\IMessengerRandomSource.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\IMessengerService.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\IMessengerSettingsProvider.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\IMessengerStateStore.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerCampaignBehavior.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerConfig.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerConfigProvider.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerIoC.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerRandomSource.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerService.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerSettingsProvider.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerStateStore.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\Domain\HeroSnapshot.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\Domain\MessengerValidationResult.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\Domain\PendingMessenger.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\Domain\PositionUpdate.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\ISiegeDismountService.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\ISiegeDismountSettingsProvider.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\SiegeDismountIoC.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\SiegeDismountService.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\SiegeDismountSettingsProvider.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\Hooks\SiegeDismountMissionBehavior.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\Models\IMountSnapshot.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\Models\MountSnapshot.cs
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\Models\SiegeMountBehaviorType.cs
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerConfigProviderTests.cs
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerServiceTests.cs
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerStateStoreTests.cs
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\SiegeDismount\SiegeDismountServiceTests.cs
...
public class SiegeDismountService : ISiegeDismountService
{
    ...
    // versions included "gate" and "wall", which falsely matched real DOTS castle scenes
...
namespace DOTS.Features.SiegeDismount.Hooks;
...
===== C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\Models\IMountSnapshot.cs
namespace DOTS.Features.SiegeDismount.Models;
...
===== C:\Users\mikew\source\repos\DOTS\Main\Adapters\IPartyMountInventoryAdapter.cs
using DOTS.Features.SiegeDismount.Models;
...
===== C:\Users\mikew\source\repos\DOTS\Main\Adapters\IPlayerMountAdapter.cs
using DOTS.Features.SiegeDismount.Models;
...
===== C:\Users\mikew\source\repos\DOTS\Main\Adapters\PartyMountInventoryAdapter.cs
...
===== C:\Users\mikew\source\repos\DOTS\Main\Adapters\PlayerMountAdapter.cs
using TaleWorlds.CampaignSystem;
using TaleWorlds.Core;
using TaleWorlds.ObjectSystem;
using DOTS.Features.SiegeDismount.Models;
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -Path Main\\**\\*.cs -Pattern 'string\\?' -SimpleMatch | Select-Object -First 20" in C:\Users\mikew\source\repos\DOTS
 succeeded in 454ms:
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Recurse -Filter *.cs Main | Select-String -Pattern 'string\\?' | Select-Object -First 20 Path,LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
 succeeded in 499ms:

[32;1mPath                                                                                 [0m[32;1m LineNumber[0m[32;1m Line[0m
[32;1m----                                                                                 [0m [32;1m----------[0m [32;1m----[0m
C:\Users\mikew\source\repos\DOTS\Main\Features\FactionMap\FactionSelectionService.cs          30     public string? Ge…
C:\Users\mikew\source\repos\DOTS\Main\Features\FactionMap\IFactionSelectionService.cs          8     string? GetCultur…
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\ISiegeDismountService.cs          9     void OnMissionSta…
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\SiegeDismountService.cs          37     public void OnMis…
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\SiegeDismountService.cs         139     private static bo…
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\Models\IMountSnapshot.cs          7     string? MountItem…
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\Models\IMountSnapshot.cs          8     string? HarnessIt…
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\Models\MountSnapshot.cs           7     public MountSnaps…
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\Models\MountSnapshot.cs          15     public string? Mo…
C:\Users\mikew\source\repos\DOTS\Main\Features\SiegeDismount\Models\MountSnapshot.cs          16     public string? Ha…


exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command 'foreach ($f in Get-ChildItem -Recurse -File Main'"\\Features\\Messengers\\*.cs) { \"===== "'$($f.FullName)"; Get-Content $f.FullName }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 481ms:
===== C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\Domain\HeroSnapshot.cs
namespace DOTS.Features.Messengers.Domain;
...
public class MessengerCampaignBehavior : CampaignBehaviorBase, IMissionListener
{
    ...
    public override void SyncData(IDataStore dataStore)
    {
        if (dataStore.IsSaving)
        {
            ...
            dataStore.SyncData("_dots_messengers", ref snapshot);
        }
        else
        {
    ...
    public void SendMessenger(Hero targetHero)
    {
        ...
        {
            ShowInquiry(
                new TextObject("{=dots_messenger_cannot_send}Cannot Send Messenger").ToString(),
        ...
        var sentText = new TextObject("{=dots_messenger_sent}A messenger has been dispatched to {HERO_NAME} and will arrive within {DAYS} days.");
        sentText.SetTextVariable("HERO_NAME", targetHero.Name);
        sentText.SetTextVariable("DAYS", _settings.MessengerTravelDays);
        ShowInquiry(
            new TextObject("{=dots_messenger_sent_title}Messenger Sent").ToString(),
            sentText.ToString(),
            affirmative: GameTexts.FindText("str_ok").ToString());
    }
    ...
    private ArrivedHandleOutcome HandleArrivedMessenger(PendingMessenger messenger)
    {
        ...
        {
            var text = new TextObject("{=dots_messenger_confused}The messenger seems confused — they were trying to reach someone in your own party!");
            text.SetTextVariable("HERO_NAME", target.Name);
            ShowInquiry(
                new TextObject("{=dots_messenger_error}Messenger Error").ToString(),
                text.ToString(),
                affirmative: GameTexts.FindText("str_ok").ToString());
            return ArrivedHandleOutcome.RemoveFromList;
        }
        ...
        var arrivalText = new TextObject("{=dots_messenger_arrived}A messenger from {HERO_NAME} has arrived. Do you wish to speak with them?");
        arrivalText.SetTextVariable("HERO_NAME", target.Name);

        InformationManager.ShowInquiry(new InquiryData(
                new TextObject("{=dots_messenger_arrived_title}Messenger Arrived").ToString(),
                arrivalText.ToString(),
                isAffirmativeOptionShown: true,
                isNegativeOptionShown: true,
                affirmativeText: new TextObject("{=dots_messenger_speak}Speak").ToString(),
                negativeText: new TextObject("{=dots_messenger_dismiss}Dismiss").ToString(),
    ...
    private void NotifyAccident(PendingMessenger messenger)
    {
        ...
        var text = new TextObject("{=dots_messenger_lost}Your messenger to {HERO_NAME} was ambushed by bandits and never arrived.");
        text.SetTextVariable("HERO_NAME", targetName);
        ShowInquiry(
            new TextObject("{=dots_messenger_lost_title}Messenger Lost").ToString(),
            text.ToString(),
            affirmative: GameTexts.FindText("str_ok").ToString());
    }
    ...
    private void AddDialogOptions(CampaignGameStarter starter)
    {
        starter.AddPlayerLine(
            "dots_messenger_send_init",
            "hero_main_options",
            "dots_messenger_send_confirm",
            "{=dots_messenger_dialog_init}I need to send you a message later. Can I dispatch a messenger to you?",
            DialogCondition_CanSend,
            null);

        starter.AddDialogLine(
            "dots_messenger_send_npc_accept",
            "dots_messenger_send_confirm",
            "dots_messenger_send_choice",
            "{=dots_messenger_dialog_npc_accept}Of course. I'll make sure to receive your messenger when they arrive.",
            null, null);

        starter.AddPlayerLine(
            "dots_messenger_send_choice_yes",
            "dots_messenger_send_choice",
            "dots_messenger_dialog_sent",
            "{=dots_messenger_dialog_send}Send the messenger ({COST} denars)",
            DialogCondition_HasGold,
            DialogConsequence_DispatchMessenger);

        starter.AddPlayerLine(
            "dots_messenger_send_choice_no",
            "dots_messenger_send_choice",
            "dots_messenger_dialog_decline_ack",
            "{=dots_messenger_dialog_decline}On second thought, never mind.",
            null, null);
        ...
        starter.AddDialogLine(
            ...
            "dots_messenger_dialog_sent",
            "close_window",
            "{=dots_messenger_dialog_sent}I'll be expecting your messenger then.",
            null, null);
        ...
        starter.AddDialogLine(
            ...
            "dots_messenger_dialog_decline_ack",
            "close_window",
            "{=dots_messenger_dialog_decline_ack}As you wish.",
            null, null);
    }
    ...
    private TextObject BuildValidationReason(MessengerValidationResult result, Hero target)
    {
        ...
        switch (result)
        {
            ...
            case MessengerValidationResult.HumanPlayerCharacter:
                return new TextObject("{=dots_messenger_invalid_target}Invalid target.");
            case MessengerValidationResult.InsufficientGold:
                text = new TextObject("{=dots_messenger_no_gold}Not enough gold! You need {COST} denars.");
                text.SetTextVariable("COST", _settings.MessengerGoldCost);
                return text;
            case MessengerValidationResult.AlreadyPending:
                return new TextObject("{=dots_messenger_already_sent}A messenger has already been dispatched to this person.");
            case MessengerValidationResult.HeroDead:
                text = new TextObject("{=dots_messenger_hero_dead}{HERO_NAME} is dead.");
                text.SetTextVariable("HERO_NAME", target?.Name ?? new TextObject(""));
                return text;
            case MessengerValidationResult.HeroPrisoner:
                text = new TextObject("{=dots_messenger_hero_prisoner}{HERO_NAME} is imprisoned and cannot receive messengers.");
                text.SetTextVariable("HERO_NAME", target?.Name ?? new TextObject(""));
                return text;
            case MessengerValidationResult.HeroFugitive:
                text = new TextObject("{=dots_messenger_hero_fugitive}{HERO_NAME} is fugitive and cannot be found.");
                text.SetTextVariable("HERO_NAME", target?.Name ?? new TextObject(""));
                return text;
            case MessengerValidationResult.HeroChild:
                text = new TextObject("{=dots_messenger_hero_child}{HERO_NAME} is too young to receive messengers.");
                text.SetTextVariable("HERO_NAME", target?.Name ?? new TextObject(""));
                return text;
            case MessengerValidationResult.TargetInPlayerParty:
                text = new TextObject("{=dots_messenger_confused}The messenger seems confused — they were trying to reach someone in your own party!");
                text.SetTextVariable("HERO_NAME", target?.Name ?? new TextObject(""));
                return text;
            default:
                return new TextObject("{=dots_messenger_target_unavailable}This person cannot be reached by messenger at this time.");
        }
    }
...
{
    public bool EnableMessengers => DotsSettings.Instance?.EnableMessengers ?? true;
    public int MessengerGoldCost => DotsSettings.Instance?.MessengerGoldCost ?? 50;
    public int MessengerTravelDays => DotsSettings.Instance?.MessengerTravelDays ?? 3;
    public bool MessengerAccidents => DotsSettings.Instance?.MessengerAccidents ?? true;
}
===== C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerStateStore.cs
using System.Collections.Generic;
using DOTS.Core.Logging;
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Recurse -File Main,DOTS.Tests | Select-String -Pattern \"MessengerIoC|MessengerCampaignBehavior|IMessengerService|SendMessenger\\(\" | Select-Object Path,LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
 succeeded in 42596ms:

[32;1mPath                                                                                         [0m[32;1m LineNumber[0m[32;1m Line[0m
[32;1m----                                                                                         [0m [32;1m----------[0m [32;1m----[0m
C:\Users\mikew\source\repos\DOTS\Main\bin\Debug\net472\DOTS.dll                                    14702  e �' e( …
C:\Users\mikew\source\repos\DOTS\Main\bin\Debug\net472\DOTS.pdb                                     1232 ��C�ֱ�2[�}��…
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\IMessengerService.cs                         6 public interf…
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\IMessengerService.cs                         8     Messenger…
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerCampaignBehavior.cs                19 public class …
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerCampaignBehavior.cs                21     private r…
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerCampaignBehavior.cs                34     public Me…
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerCampaignBehavior.cs                35         IMess…
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerCampaignBehavior.cs                75     public vo…
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerCampaignBehavior.cs                79         var v…
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerCampaignBehavior.cs               108     public bo…
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerCampaignBehavior.cs               110         var v…
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerCampaignBehavior.cs               423         retur…
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerCampaignBehavior.cs               436         SendM…
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerIoC.cs                              5 public static…
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerIoC.cs                             13         conta…
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerService.cs                          7 public class …
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerService.cs                         26     public Me…
C:\Users\mikew\source\repos\DOTS\Main\obj\Debug\net472\DOTS.dll                                    14702  e �' e( …
C:\Users\mikew\source\repos\DOTS\Main\obj\Debug\net472\DOTS.pdb                                     1232 ��C�ֱ�2[�}��…
C:\Users\mikew\source\repos\DOTS\Main\_Module\bin\Gaming.Desktop.x64_Shipping_Client\DOTS.dll      14702  e �' e( …
C:\Users\mikew\source\repos\DOTS\Main\_Module\bin\Gaming.Desktop.x64_Shipping_Client\DOTS.pdb       1232 ��C�ֱ�2[�}��…
C:\Users\mikew\source\repos\DOTS\Main\_Module\bin\Win64_Shipping_Client\DOTS.dll                   14702  e �' e( …
C:\Users\mikew\source\repos\DOTS\Main\_Module\bin\Win64_Shipping_Client\DOTS.pdb                    1232 ��C�ֱ�2[�}��…
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\bin\Debug\net472\DOTS.dll                              14702  e �' e( …
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\bin\Debug\net472\DOTS.pdb                               1232 ��C�ֱ�2[�}��…
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerServiceTests.cs              50         var r…
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerServiceTests.cs              62         var r…
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerServiceTests.cs              75         var r…
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerServiceTests.cs              88         var r…
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerServiceTests.cs             101         var r…
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerServiceTests.cs             114         var r…
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerServiceTests.cs             127         var r…
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerServiceTests.cs             140         var r…
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerServiceTests.cs             150         var r…
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerServiceTests.cs             160         var r…
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerServiceTests.cs             173         var r…
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerServiceTests.cs             181         var r…
C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerServiceTests.cs             191         var r…


exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command 'foreach ($f in Get-ChildItem -Recurse -File DOTS.Tests'"\\Features\\Messengers\\*.cs,DOTS.Tests\\Features\\SiegeDismount\\*.cs) { \"===== "'$($f.FullName)"; Get-Content $f.FullName }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 501ms:
===== C:\Users\mikew\source\repos\DOTS\DOTS.Tests\Features\Messengers\MessengerConfigProviderTests.cs
using System.IO;
using Microsoft.VisualStudio.TestTools.UnitTesting;
...
namespace DOTS.Tests.Features.Messengers;
...
public class MessengerConfigProviderTests
{
    ...
    public void Setup()
    {
        _tempDir = Path.Combine(Path.GetTempPath(), "DOTS_Messengers_" + Path.GetRandomFileName());
...
namespace DOTS.Tests.Features.SiegeDismount;
...
public class SiegeDismountServiceTests
{
    ...
    // -------- Regression: DOTS castle false-positives (deep-review GAP 2) --------
    // castle_orthanc_gate (Isengard) and castle_gundabad_wall (Gundabad) are real DOTS
    ...
    public void OnMissionStart_DotsCastleSceneWithGateOrWallSubstring_DoesNotTriggerDismount(string sceneName)
    {
        _sut.OnMissionStart(isSiegeBattle: false, sceneName: sceneName);
    ...
    // If a user manually edits DOTS.json and sets SiegeMountBehavior to 99, the cast
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Recurse -Filter AssemblyInfo.cs Main | Select-String -Pattern 'InternalsVisibleTo' -Context 0; Select-String -Path Main\\*.csproj,DOTS.Tests\\*.csproj -Pattern 'InternalsVisibleTo|LangVersion'" in C:\Users\mikew\source\repos\DOTS
 succeeded in 493ms:

Main\DOTS.csproj:88:	<!-- [7mInternalsVisibleTo[0m for unit testing and DOTS_Online multiplayer module -->
Main\DOTS.csproj:90:		<AssemblyAttribute Include="System.Runtime.CompilerServices.[7mInternalsVisibleTo[0m">
Main\DOTS.csproj:93:		<AssemblyAttribute Include="System.Runtime.CompilerServices.[7mInternalsVisibleTo[0m">


exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-Content Main\\DOTS.csproj | Select-Object -Skip 75 -First 25" in C:\Users\mikew\source\repos\DOTS
 succeeded in 455ms:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command 'Get-Command ilspycmd -ErrorAction SilentlyContinue | Select-Object -ExpandProperty Source' in C:\Users\mikew\source\repos\DOTS
 succeeded in 447ms:
C:\Users\mikew\.dotnet\tools\ilspycmd.exe

exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command 'ilspycmd --help | Select-Object -First 40' in C:\Users\mikew\source\repos\DOTS
 succeeded in 534ms:
ilspycmd: 9.1.0.7988
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$dll='"'E:\\Steam\\steamapps\\common\\Mount & Blade II Bannerlord\\bin\\Win64_Shipping_Client\\TaleWorlds.Core.dll'; "'$out=ilspycmd -t TaleWorlds.Core.Equipment $dll; $out | Select-String -Pattern '"'public void FillFrom' -Context 0,18" in C:\Users\mikew\source\repos\DOTS
 succeeded in 1122ms:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content Main'"\\Adapters\\PlayerEquipmentAdapter.cs | ForEach-Object { '{0,4}: {1}' -f "'$i, $_; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 432ms:
   1: using System.Linq;
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command 'git diff -- Main/_Module/ModuleData/startup_resources/startup_resources_config.xml Main/_Module/ModuleData/charactercreation/youth_menu.json' in C:\Users\mikew\source\repos\DOTS
 succeeded in 319ms:
...
@@ -818,7 +818,7 @@
     {
         "string_id": "dots_youth_sturgia_1",
         "culture_id": "sturgia",
-        "title_type": "retainer",
+        "title_type": "guard",
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -Path Main\\_Module\\ModuleData\\dots_spcultures.xml,Main\\_Module\\ModuleData\\DOTS_spkingdoms.xml -Pattern 'id=\"(rivendell|lothlorien|mirkwood|erebor|gondor|vlandia|sturgia|empire|battania|aserai|khuzait|mordor|isengard|gundabad|dolguldur|umbar)\"' | Select-Object Path,LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
 succeeded in 442ms:

[32;1mPath                                                                        [0m[32;1m LineNumber[0m[32;1m Line[0m
[32;1m----                                                                        [0m [32;1m----------[0m [32;1m----[0m
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\dots_spcultures.xml          7     id="erebor"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\dots_spcultures.xml        370     id="rivendell"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\dots_spcultures.xml        739     id="mirkwood"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\dots_spcultures.xml       1099     id="lothlorien"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\dots_spcultures.xml       1460     id="isengard"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\dots_spcultures.xml       1821     id="gundabad"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\dots_spcultures.xml       2181     id="umbar"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\dots_spcultures.xml       2540     id="dolguldur"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\dots_spcultures.xml       2900     id="gondor"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\dots_spcultures.xml       3269     id="mordor"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\DOTS_spkingdoms.xml          5         id="erebor"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\DOTS_spkingdoms.xml         92         id="rivendell"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\DOTS_spkingdoms.xml        178         id="mirkwood"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\DOTS_spkingdoms.xml        265         id="lothlorien"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\DOTS_spkingdoms.xml        352         id="isengard"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\DOTS_spkingdoms.xml        443         id="gundabad"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\DOTS_spkingdoms.xml        534         id="umbar"
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\DOTS_spkingdoms.xml        625         id="dolguldur"


exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command 'Get-ChildItem -Recurse -File Main | Where-Object { $_.Extension -in '"'.cs','.xml','.json','.md' } | Select-String -Pattern 'player_char_creation_' | Select-Object Path,LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
 succeeded in 596ms:

[32;1mPath                                                                                                   [0m[32;1m LineNumber[0m[32;1m Line[0m
[32;1m----                                                                                                   [0m [32;1m----------[0m [32;1m----[0m
C:\Users\mikew\source\repos\DOTS\Main\Features\CharacterCreation\PlayerEquipmentRosterIds.cs                     7    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        210 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        222 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        234 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        246 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        258 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        270 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        282 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        294 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        306 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        318 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        330 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        342 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        354 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        366 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        378 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        390 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        402 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        414 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        426 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        438 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        450 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        462 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        474 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        486 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        499 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        541 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        583 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        625 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        667 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        712 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        757 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        799 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        841 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        880 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        919 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        961 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1003 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1045 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1087 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1126 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1166 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1382 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1394 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1406 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1418 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1430 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1442 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1454 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1466 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1478 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1490 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1502 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1514 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1526 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1538 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1550 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1562 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1574 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1586 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1598 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1610 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1622 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1634 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1646 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1658 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1671 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1710 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1749 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1788 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1827 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1869 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1911 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1950 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1989 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2025 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2061 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2100 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2139 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2178 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2217 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2253 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2290 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2518 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2530 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2542 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2554 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2566 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2578 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2590 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2602 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2614 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2626 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2638 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2650 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2662 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2674 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2686 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2698 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2710 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2722 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2734 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2746 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2758 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2770 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2782 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2794 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2807 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2849 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2891 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2933 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2975 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3020 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3065 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3107 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3149 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3188 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3227 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3269 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3311 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3353 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3395 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3434 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3474 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3702 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3714 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3726 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3738 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3750 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3762 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3774 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3786 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3798 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3810 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3822 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3834 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3846 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3858 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3870 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3882 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3894 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3906 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3918 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3930 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3942 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3954 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3966 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3978 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3991 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4033 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4075 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4117 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4159 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4204 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4249 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4291 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4333 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4372 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4411 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4453 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4495 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4537 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4579 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4618 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4658 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4886 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4898 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4910 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4922 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4934 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4946 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4958 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4970 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4982 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4994 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5006 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5018 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5030 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5042 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5054 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5066 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5078 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5090 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5102 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5114 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5126 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5138 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5150 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5162 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5175 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5217 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5259 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5301 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5343 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5388 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5433 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5475 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5517 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5556 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5595 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5637 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5679 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5721 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5763 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5802 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5842 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6070 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6082 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6094 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6106 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6118 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6130 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6142 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6154 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6166 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6178 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6190 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6202 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6214 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6226 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6238 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6250 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6262 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6274 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6286 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6298 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6310 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6322 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6334 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6346 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6359 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6401 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6443 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6485 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6527 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6572 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6617 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6659 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6701 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6740 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6779 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6821 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6863 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6905 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6947 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6986 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7026 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7254 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7266 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7278 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7290 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7302 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7314 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7326 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7338 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7350 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7362 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7374 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7386 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7398 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7410 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7422 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7434 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7446 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7458 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7470 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7482 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7494 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7506 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7518 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7530 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7543 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7585 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7627 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7669 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7711 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7753 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7795 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7834 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7873 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7912 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7951 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       7993 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8035 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8074 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8113 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8152 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8192 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8420 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8432 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8444 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8456 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8468 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8480 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8492 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8504 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8516 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8528 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8540 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8552 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8564 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8576 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8588 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8600 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8612 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8624 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8636 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8648 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8660 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8672 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8684 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8696 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8709 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8751 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8793 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8835 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8877 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8919 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       8961 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9000 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9039 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9078 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9117 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9156 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9195 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9231 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9267 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9306 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9346 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9574 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9586 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9598 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9610 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9622 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9634 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9646 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9658 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9670 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9682 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9694 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9706 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9718 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9730 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9742 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9754 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9766 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9778 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9790 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9802 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9814 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9826 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9838 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9850 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9863 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9905 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9947 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       9989 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10031 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10076 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10121 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10163 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10205 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10244 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10283 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10325 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10367 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10409 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10451 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10490 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10530 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10758 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10770 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10782 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10794 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10806 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10818 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10830 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10842 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10854 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10866 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10878 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10890 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10902 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10914 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10926 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10938 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10950 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10962 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10974 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10986 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      10998 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11010 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11022 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11034 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11047 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11089 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11131 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11173 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11215 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11260 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11305 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11347 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11389 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11428 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11467 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11509 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11551 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11590 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11629 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11668 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11708 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11936 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11948 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11960 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11972 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11984 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      11996 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12008 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12020 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12032 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12044 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12056 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12068 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12080 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12092 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12104 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12116 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12128 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12140 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12152 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12164 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12176 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12188 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12200 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12212 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12225 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12267 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12309 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12351 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12393 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12438 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12483 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12525 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12567 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12606 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12645 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12687 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12729 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12771 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12813 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12852 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      12892 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13120 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13132 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13144 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13156 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13168 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13180 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13192 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13204 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13216 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13228 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13240 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13252 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13264 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13276 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13288 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13300 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13312 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13324 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13336 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13348 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13360 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13372 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13384 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13396 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13409 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13451 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13493 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13535 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13577 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13622 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13667 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13709 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13751 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13790 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13829 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13871 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13913 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13955 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      13997 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      14036 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml      14076 		i…


exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Recurse -File Main -Include *.cs | Select-String -Pattern 'player_char_creation_' | Select-Object Path,LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
 succeeded in 665ms:

[32;1mPath                                                                                        [0m[32;1m LineNumber[0m[32;1m Line[0m
[32;1m----                                                                                        [0m [32;1m----------[0m [32;1m----[0m
C:\Users\mikew\source\repos\DOTS\Main\Features\CharacterCreation\PlayerEquipmentRosterIds.cs          7         return…
...
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content Main'"\\Features\\CharacterCreation\\NarrativeMenuBuilder.cs | ForEach-Object { '{0,4}: {1}' -f "'$i, $_; $i++ }; $i=1; Get-Content Main'"\\Features\\CharacterCreation\\CareerMenuService.cs | ForEach-Object { if ("'$i -ge 190 -and $i -le 245) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 463ms:
   ...
   8: using DOTS.Core.Logging;
   9: using DOTS.Features.CharacterCreation.Models;
  10: 
  11: namespace DOTS.Features.CharacterCreation;
  12: 
  ...
  74:             new TextObject($"{{=dots_cc_{definition.StringId}_text}}{definition.Text}"),
  75:             new TextObject($"{{=dots_cc_{definition.StringId}_desc}}{definition.Description}"),
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-Content Main\\Features\\CharacterCreation\\CareerMenuService.cs" in C:\Users\mikew\source\repos\DOTS
 succeeded in 438ms:
using System;
using System.Collections.Generic;
using TaleWorlds.CampaignSystem;
...
public class CareerMenuService : ICareerMenuService
{
    ...
    public void RegisterCareerMenu(CharacterCreationManager manager)
    {
        ...
        var careerMenu = new NarrativeMenu(
            ...
            AgeSelectionMenuId,
            "",
            new TextObject("{=dots_cc_career_title}Career"),
            new TextObject("{=dots_cc_career_desc}Your experiences have set you on a path. Choose the career that will define your legend."),
            characters,
    ...
    private NarrativeMenuOption BuildFallbackOption()
    {
        ...
        return new NarrativeMenuOption(
            "dots_career_none",
            new TextObject("{=dots_cc_career_none}No specialization"),
            new TextObject("{=dots_cc_career_none_desc}You have not yet committed to a particular path. Your career will be determined by your actions in the world."),
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$dll='"'E:\\Steam\\steamapps\\common\\Mount & Blade II Bannerlord\\bin\\Win64_Shipping_Client\\TaleWorlds.CampaignSystem.dll'; ilspycmd -l c "'$dll | Select-String -Pattern '"'CharacterCreationContent' | Select-Object -First 50" in C:\Users\mikew\source\repos\DOTS
 succeeded in 645ms:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -Path Main\\SubModule.cs -Pattern 'AddBehavior|CampaignBehavior|Messenger|StartupResources|Register.*Feature' -Context 1" in C:\Users\mikew\source\repos\DOTS
 succeeded in 482ms:

  Main\SubModule.cs:26:using DOTS.Features.RaceAge.Models;
> Main\SubModule.cs:27:using DOTS.Features.[7mStartupResources[0m;[0m
[7m[0m  Main\SubModule.cs:28:using DOTS.Features.NamedCompanions;[0m
...
[7m[0mDotsInitialChildGenerationBehavior(childGenService));[0m
...
[7m[0m  Main\SubModule.cs:241:            campaignStarter.AddModel(new DotsAgeModel(raceAgeService));[0m
...
[7m[0m  Main\SubModule.cs:249:            campaignStarter.AddModel(new DotsAllianceModel(diplomacyService));[0m
...
[7m[0mDotsSiegeEventModel(IoC.Resolve<ISiegeEngineAvailabilityService>()));[0m
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content Main'"\\SubModule.cs | ForEach-Object { if ("'$i -ge 205 -and $i -le 335) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 460ms:
 205:                 isHidden:            null));
 206:         }
 207:     }
 ...
 227:             campaignStarter.AddBehavior(new DotsInitialChildGenerationBehavior(childGenService));
 228: 
 ...
 233:             campaignStarter.AddModel(new DotsCharacterStatsModel());
 234:             campaignStarter.AddModel(new DotsPartyWageModel(costService));
 235:             campaignStarter.AddModel(new DotsVolunteerModel(volunteerService, recruitmentService, volunteerContextAdapter));
 236: 
 ...
 241:             campaignStarter.AddModel(new DotsAgeModel(raceAgeService));
 242:             campaignStarter.AddModel(new DotsPregnancyModel(raceAgeService));
 243:             campaignStarter.AddModel(new DotsHeroCreationModel());
 244: 
 ...
 249:             campaignStarter.AddModel(new DotsAllianceModel(diplomacyService));
 250:             campaignStarter.AddModel(new DotsKingdomDecisionPermissionModel(diplomacyService, wotrService));
 251:             campaignStarter.AddModel(new DotsDiplomacyModel(wotrService));
 252: 
 ...
 259:             campaignStarter.AddModel(new DotsSiegeEventModel(IoC.Resolve<ISiegeEngineAvailabilityService>()));
 260: 
 261:             var executionAction = IoC.Resolve<IOnExecutionAction>();
 262:             campaignStarter.AddModel(new DotsExecutionRelationModel(executionAction));
 263: 
 264:             // Cultural feat models
 265:             campaignStarter.AddModel(new DotsArmyManagementModel());
 266:             campaignStarter.AddModel(new DotsPartySpeedModel());
 267:             campaignStarter.AddModel(new DotsSettlementProsperityModel());
 268:             campaignStarter.AddModel(new DotsSettlementMilitiaModel());
 269:             campaignStarter.AddModel(new DotsBuildingConstructionModel());
 270:             campaignStarter.AddModel(new DotsVillageProductionModel());
 271:             campaignStarter.AddModel(new DotsCaravanModel());
 272:             campaignStarter.AddModel(new DotsBattleRewardModel());
 273:             campaignStarter.AddModel(new DotsTournamentModel());
 274:             campaignStarter.AddModel(new DotsPartyTroopUpgradeModel());
 275:             campaignStarter.AddModel(new DotsPartySizeModel());
 276:             campaignStarter.AddModel(new DotsFoodConsumptionModel());
 277:             campaignStarter.AddModel(new DotsSettlementLoyaltyModel(IoC.Resolve<IRevoltTuningConfigProvider>()));
 278:             campaignStarter.AddModel(new DotsPartyMoraleModel());
 279:             campaignStarter.AddModel(new DotsSmithingModel());
 280:             campaignStarter.AddModel(new DotsClanFinanceModel());
 281:             campaignStarter.AddModel(new DotsRaidModel());
 282: 
 ...
 286:             campaignStarter.AddModel(new DotsMilitaryPowerModel(battleBalanceSettings, battleBalanceConfig));
 287:             campaignStarter.AddModel(new DotsCombatSimulationModel(battleBalanceSettings));
 288:             campaignStarter.AddModel(new DotsPartyHealingModel(battleBalanceSettings, battleBalanceConfig));
 289: 
 290:             campaignStarter.AddModel(new DotsInformationRestrictionModel());
 291: 
 292:             var armyTargetingService = IoC.Resolve<IArmyTargetingService>();
 293:             campaignStarter.AddModel(new DotsTargetScoreModel(armyTargetingService));
 294: 
 ...
 319:             campaignStarter.AddModel(new DotsMapVisibilityModel());
 320:             campaignStarter.AddModel(new DotsInventoryCapacityModel());
 321:             campaignStarter.AddModel<AgentStatCalculateModel>(new DotsAgentStatCalculateModel(careerPassiveService));
 322:             campaignStarter.AddModel<AgentApplyDamageModel>(new DotsAgentApplyDamageModel(careerPassiveService));
 323:             campaignStarter.AddModel(new DotsClanTierModel(careerPassiveService));
 324: 
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content Main'"\\Features\\StartupResources\\PlayerStartupGoldService.cs | ForEach-Object { '{0,4}: {1}' -f "'$i, $_; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 432ms:
   1: using System;
   2: using System.Linq;
   3: using DOTS.Adapters;
   4: using DOTS.Core.Logging;
   5: 
   6: namespace DOTS.Features.StartupResources;
   7: 
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-Content Main\\_Module\\ModuleData\\equipmentsets\\dots_char_creation_equipment.xml | Select-Object -Skip 200 -First 70" in C:\Users\mikew\source\repos\DOTS
 succeeded in 444ms:
				slot="Body"
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -Path Main\\_Module\\ModuleData\\equipmentsets\\dots_char_creation_equipment.xml -Pattern 'player_char_creation_sturgia_(retainer|guard)_[mf]' -Context 0,2" in C:\Users\mikew\source\repos\DOTS
 succeeded in 432ms:
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -Path Main\\_Module\\ModuleData\\equipmentsets\\dots_char_creation_equipment.xml -Pattern 'player_char_creation_.*sturgia' | Select-Object -First 50 LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
 succeeded in 425ms:
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Recurse -File Main\\_Module\\ModuleData | Select-String -Pattern 'player_char_creation_sturgia|sturgia_guard|retainer' | Select-Object -First 100 Path,LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
 succeeded in 561ms:

[32;1mPath                                                                                                   [0m[32;1m LineNumber[0m[32;1m Line[0m
[32;1m----                                                                                                   [0m [32;1m----------[0m [32;1m----[0m
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\dots_cc_strings.xml                                   273 	<s…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\dots_cc_strings.xml                                  1353 	<s…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\adulthood_menu.json                 593    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                   5    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                  95    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                 185    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                 275    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                 365    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                 455    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                 545    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                 635    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                 725    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                 815    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                 905    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                 995    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                1085    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                1175    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                1265    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\education_menu.json                1355    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                    12    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                    85    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                   158    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                   231    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                   304    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                   377    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                   450    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                   523    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                   596    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                   669    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                   742    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                   808    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                   815    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                   888    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                   961    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                  1034    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\parents_menu.json                  1107    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\youth_menu.json                       5    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\youth_menu.json                      65    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\youth_menu.json                     209    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\youth_menu.json                     329    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\youth_menu.json                     389    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\youth_menu.json                     461    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\youth_menu.json                     533    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\youth_menu.json                     605    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\youth_menu.json                     677    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\youth_menu.json                     749    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\youth_menu.json                     893    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\youth_menu.json                     965    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\youth_menu.json                    1037    …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml         37 	<!…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml         39 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml         57 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        210 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        222 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        234 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        246 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        499 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml        541 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1218 	<!…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1220 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1235 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1382 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1394 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1406 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1418 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1671 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       1710 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2345 	<!…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2347 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2365 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2518 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2530 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2542 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2554 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2807 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       2849 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3529 	<!…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3531 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3549 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3702 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3714 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3726 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3738 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       3991 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4033 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4713 	<!…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4715 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4733 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4886 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4898 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4910 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       4922 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5175 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5217 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5897 	<!…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5899 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       5917 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6070 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6082 		i…
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml       6094 		i…
...
import re, pathlib
p=pathlib.Path('Main/_Module/ModuleData/equipmentsets/dots_char_creation_equipment.xml')
...
'@ | python -" in C:\Users\mikew\source\repos\DOTS
 succeeded in 469ms:
abanissa
childhood
dolguldur
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem 'E:\\Steam\\steamapps\\common\\Mount & Blade II Bannerlord\\Modules' -Recurse -File -Include *.xml | Select-String -Pattern 'player_char_creation_sturgia_(guard|retainer)_[mf]' | Select-Object Path,LineNumber,Line -First 20" in C:\Users\mikew\source\repos\DOTS
 succeeded in 8593ms:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -Path 'E:\\Steam\\steamapps\\common\\Mount & Blade II Bannerlord\\Modules\\SandBox\\ModuleData\\sandbox_equipment_sets.xml' -Pattern 'player_char_creation_sturgia_(guard|retainer)_[mf]' -Context 0,1 | Format-List" in C:\Users\mikew\source\repos\DOTS
 succeeded in 446ms:
...
# collect roster ids in DOTS + vanilla modules
ids=set()
paths=[pathlib.Path('Main/_Module/ModuleData/equipmentsets/dots_char_creation_equipment.xml'), pathlib.Path(r'E:/Steam/steamapps/common/Mount & Blade II Bannerlord/Modules/SandBox/ModuleData/sandbox_equipment_sets.xml')]
for p in paths:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -Path Main\\_Module\\ModuleData\\equipmentsets\\dots_char_creation_equipment.xml -Pattern 'id=\"player_char_creation_gondor_retainer_m\"' -Context 0,60" in C:\Users\mikew\source\repos\DOTS
 succeeded in 460ms:

> Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:499:		
[7mid="player_char_creation_gondor_retainer_m"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:500:		culture="Culture.gondor">[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:501:		<EquipmentSet>[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:502:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:503:				slot="Item0"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:504:				id="Item.wm_gondor_sword_a01" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:505:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:506:				slot="Item1"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:507:				id="Item.gond_shld2" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:508:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:509:				slot="Item2"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:510:				id="Item.wm_gondor_spear" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:511:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:512:				slot="Body"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:513:				id="Item.gondor_noble_jerkin_a" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:514:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:515:				slot="Leg"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:516:				id="Item.sk_gd_ano_boots_a" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:517:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:518:				slot="Horse"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:519:				id="Item.sumpter_horse" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:520:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:521:				slot="HorseHarness"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:522:				id="Item.light_harness" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:523:		</EquipmentSet>[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:524:		<EquipmentSet[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:525:			civilian="true">[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:526:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:527:				slot="Item0"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:528:				id="Item.wm_gondor_sword_a01" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:529:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:530:				slot="Body"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:531:				id="Item.gondor_noble_coat_b" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:532:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:533:				slot="Cape"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:534:				id="Item.ithilien_cloak" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:535:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:536:				slot="Leg"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:537:				id="Item.sk_gd_ano_boots_a" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:538:		</EquipmentSet>[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:539:	</EquipmentRoster>[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:540:	<EquipmentRoster[0m
[7m [0m[7m [0m[7m[0mMain\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:541:	[0m[7m	[0m
[7m[0mid="player_char_creation_gondor_retainer_f"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:542:		culture="Culture.gondor">[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:543:		<EquipmentSet>[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:544:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:545:				slot="Item0"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:546:				id="Item.wm_gondor_sword_a01" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:547:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:548:				slot="Item1"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:549:				id="Item.gond_shld2" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:550:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:551:				slot="Item2"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:552:				id="Item.wm_gondor_spear" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:553:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:554:				slot="Body"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:555:				id="Item.gondor_noble_jerkin_a" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:556:			<Equipment[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:557:				slot="Leg"[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:558:				id="Item.sk_gd_ano_boots_a" />[0m
[7m[0m  Main\_Module\ModuleData\equipmentsets\dots_char_creation_equipment.xml:559:			<Equipment[0m


exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-Content Main\\Features\\CharacterCreation\\CharacterCreationRegistrationBehavior.cs,Main\\Features\\CharacterCreation\\DotsCharacterCreationContentHandler.cs" in C:\Users\mikew\source\repos\DOTS
 succeeded in 440ms:
using TaleWorlds.CampaignSystem;
using TaleWorlds.CampaignSystem.CharacterCreationContent;
using DOTS.Core.Logging;
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-Content Main\\Features\\StartupResources\\StartupResourcesBehavior.cs" in C:\Users\mikew\source\repos\DOTS
 succeeded in 417ms:
using System;
using DOTS.Core.Logging;
using TaleWorlds.CampaignSystem;
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command 'dotnet test DOTS.Tests --no-restore' in C:\Users\mikew\source\repos\DOTS
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$env:DOTNET_CLI_HOME='"'C:\\tmp\\dotnet-cli-home'; "'$env:DOTNET_SKIP_FIRST_TIME_EXPERIENCE='"'1'; "'$env:DOTNET_NOLOGO='"'1'; dotnet test DOTS.Tests --no-restore" in C:\Users\mikew\source\repos\DOTS
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "New-Item -ItemType Directory -Force -Path C:\\tmp\\dotnet-cli-home | Out-Null; Get-Item C:\\tmp\\dotnet-cli-home | Format-List FullName,Attributes" in C:\Users\mikew\source\repos\DOTS
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "New-Item -ItemType Directory -Force -Path .\\.dotnet-cli-home | Out-Null; "'$env:DOTNET_CLI_HOME=(Resolve-Path .'"\\.dotnet-cli-home).Path; "'$env:DOTNET_SKIP_FIRST_TIME_EXPERIENCE='"'1'; "'$env:DOTNET_NOLOGO='"'1'; dotnet test DOTS.Tests --no-restore" in C:\Users\mikew\source\repos\DOTS
2026-05-06T23:12:01.518451Z ERROR codex_core::tools::router: error=Exit code: 1
Wall time: 0.8 seconds
Output:
Failed to add 'C:\Users\mikew\source\repos\DOTS\.dotnet-cli-home\.dotnet\tools' to the PATH environment variable. Add this directory to your PATH to use tools installed with 'dotnet tool install'.
C:\Program Files\dotnet\sdk\10.0.107\Microsoft.Common.CurrentVersion.targets(93,5): error MSB4184: The expression "[Microsoft.Build.Utilities.ToolLocationHelper]::GetPlatformSDKLocation(Windows, 7.0)" cannot be evaluated. Access to the path 'C:\Users\mikew\AppData\Local\Microsoft SDKs' is denied. [C:\Users\mikew\source\repos\DOTS\DOTS.Tests\DOTS.Tests.csproj]
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-Content Main\\Features\\CharacterCreation\\CharacterCreationIoC.cs,Main\\Features\\StartupResources\\StartupResourcesIoC.cs" in C:\Users\mikew\source\repos\DOTS
 succeeded in 425ms:
using DryIoc;
using DOTS.Adapters;
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content Main'"\\IoC.cs | ForEach-Object { if ("'$i -ge 40 -and $i -le 90) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 430ms:
  40: {
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-Content Main\\IoC.cs | Select-Object -First 40; git diff -- Main/IoC.cs" in C:\Users\mikew\source\repos\DOTS
 succeeded in 469ms:
using DryIoc;
using System.Collections.Generic;
using DOTS.Adapters;
...
--- a/Main/IoC.cs
+++ b/Main/IoC.cs
@@ -31,6 +31,8 @@ using DOTS.Features.CareerSystem;
 using DOTS.Features.SettlementGuards;
 using DOTS.Features.NamedCompanions;
 using DOTS.Features.RevoltTuning;
+using DOTS.Features.SiegeDismount;
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "git diff -- Main/SubModule.cs | Select-String -Pattern 'Messenger|SiegeDismount' -Context 2" in C:\Users\mikew\source\repos\DOTS
 succeeded in 466ms:

   using DOTS.Features.SettlementGuards.Hooks;
   using DOTS.Features.RevoltTuning;
> +using DOTS.Features.[7mSiegeDismount[0m.Hooks;[0m
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-Content docs\\features\\siege-dismount.md -Head 80; if (Test-Path Main\\_Module\\ModuleData\\messengers) { Get-ChildItem -Recurse Main\\_Module\\ModuleData\\messengers } else { 'no messengers dir' }" in C:\Users\mikew\source\repos\DOTS
 succeeded in 446ms:
# Siege Dismount
...
- **DOTS requirement:** Optional auto-dismount with four operating modes, configurable per-player via MCM. Default is "auto-restore on siege end" so the only player-visible change is "no horse during siege."
...
| [Main/Features/SiegeDismount/SiegeDismountSettingsProvider.cs](../../Main/Features/SiegeDismount/SiegeDismountSettingsProvider.cs) | Wraps `DotsSettings.Instance` for testability |
...
| [Main/Adapters/IPartyMountInventoryAdapter.cs](../../Main/Adapters/IPartyMountInventoryAdapter.cs) | Adds/removes items from `MobileParty.MainParty.ItemRoster` |
    ...
    Directory: C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\messengers
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "git status --short --untracked-files=all | Select-String -Pattern 'messenger|Siege|Mount|PlayerEquipment|StartupGold|ModuleData'" in C:\Users\mikew\source\repos\DOTS
 succeeded in 489ms:
...
?? Main/_Module/[7mModuleData[0m/Languages/PL/std_dots_messenger_strings_pol-PL.xml
?? Main/_Module/[7mModuleData[0m/Languages/SP/std_dots_messenger_strings_spa-LA.xml
?? Main/_Module/[7mModuleData[0m/messengers/messenger_config.json
?? Main/_Module/[7mModuleData[0m/dots_messenger_strings.xml
?? DOTS.Tests/Features/CharacterCreation/[7mPlayerEquipment[0mServiceTests.cs
?? DOTS.Tests/Features/[7mMessenger[0ms/MessengerConfigProviderTests.cs
?? DOTS.Tests/Features/[7mMessenger[0ms/MessengerServiceTests.cs
?? DOTS.Tests/Features/[7mMessenger[0ms/MessengerStateStoreTests.cs
?? DOTS.Tests/Features/[7mSiege[0mDismount/SiegeDismountServiceTests.cs
?? DOTS.Tests/Features/StartupResources/Player[7mStartupGold[0mServiceTests.cs
?? docs/features/[7msiege[0m-dismount.md
?? docs/reviews/codex-prompt-[7msiege[0mdismount-2026-05-06.md


exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command 'git status --short --untracked-files=all' in C:\Users\mikew\source\repos\DOTS
 succeeded in 330ms:
 M CHANGELOG.md
 M Main/Features/CharacterCreation/CareerMenuService.cs
 M Main/Features/CharacterCreation/CharacterCreationContentService.cs
...
?? Main/Features/StartupResources/IPlayerStartupGoldService.cs
?? Main/Features/StartupResources/PlayerStartupGoldService.cs
?? Main/_Module/ModuleData/Languages/PL/std_dots_messenger_strings_pol-PL.xml
?? Main/_Module/ModuleData/Languages/SP/std_dots_messenger_strings_spa-LA.xml
?? Main/_Module/ModuleData/messengers/messenger_config.json
?? Main/_Module/ModuleData/dots_messenger_strings.xml
?? DOTS.Tests/Features/CharacterCreation/PlayerEquipmentServiceTests.cs
?? DOTS.Tests/Features/Messengers/MessengerConfigProviderTests.cs
?? DOTS.Tests/Features/Messengers/MessengerServiceTests.cs
?? DOTS.Tests/Features/Messengers/MessengerStateStoreTests.cs
?? DOTS.Tests/Features/SiegeDismount/SiegeDismountServiceTests.cs
?? DOTS.Tests/Features/StartupResources/PlayerStartupGoldServiceTests.cs
?? docs/features/siege-dismount.md
?? docs/reviews/codex-prompt-player-startup.md
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-Content Main\\Features\\Messengers\\UI\\MessengerEncyclopediaMixin.cs,Main\\Features\\Messengers\\UI\\MessengerEncyclopediaPrefabExtension.cs; git diff -- Main/_Module/SubModule.xml Main/_Module/ModuleData/Languages/PL/language_data.xml Main/_Module/ModuleData/Languages/SP/language_data.xml; Get-Content Main\\_Module\\ModuleData\\messengers\\messenger_config.json; Get-Content Main\\_Module\\ModuleData\\dots_messenger_strings.xml -Head 120" in C:\Users\mikew\source\repos\DOTS
 succeeded in 470ms:
...
namespace DOTS.Features.Messengers.UI;
...
internal sealed class MessengerEncyclopediaMixin : BaseViewModelMixin<EncyclopediaHeroPageVM>
{
    ...
    {
        _service = DOTS.IoC.Resolve<IMessengerService>();
        _settings = DOTS.IoC.Resolve<IMessengerSettingsProvider>();
        _sendMessengerHint = new HintViewModel();
        _sendMessengerActionName = new TextObject("{=dots_send_messenger}Send Messenger").ToString();
    }
    ...
    private void UpdateAvailability()
    {
        ...
        {
            IsMessengerAvailable = false;
            SendMessengerHint = new HintViewModel(new TextObject("{=dots_messenger_target_unavailable}This person cannot be reached by messenger at this time."));
            return;
        }
        ...
        {
            IsMessengerAvailable = false;
            SendMessengerHint = new HintViewModel(new TextObject("{=dots_messenger_disabled}The messenger system is disabled in settings."));
            return;
        }
        ...
        {
            IsMessengerAvailable = false;
            SendMessengerHint = new HintViewModel(new TextObject("{=dots_messenger_not_available}Messenger system not available."));
            return;
        }
...
@@ -5,4 +5,5 @@
   <LanguageFile xml_path="PL/std_dots_named_companion_strings_pol-PL.xml" />
   <LanguageFile xml_path="PL/std_dots_cc_strings_pol-PL.xml" />
   <LanguageFile xml_path="PL/std_dots_career_strings_pol-PL.xml" />
+  <LanguageFile xml_path="PL/std_dots_messenger_strings_pol-PL.xml" />
 </LanguageData>
...
@@ -5,4 +5,5 @@
   <LanguageFile xml_path="SP/std_dots_named_companion_strings_spa-LA.xml" />
   <LanguageFile xml_path="SP/std_dots_cc_strings_spa-LA.xml" />
   <LanguageFile xml_path="SP/std_dots_career_strings_spa-LA.xml" />
+  <LanguageFile xml_path="SP/std_dots_messenger_strings_spa-LA.xml" />
 </LanguageData>
...
<strings>
	...
	<string id="dots_send_messenger" text="{=dots_send_messenger}Send Messenger" />
	<string id="dots_messenger_target_unavailable" text="{=dots_messenger_target_unavailable}This person cannot be reached by messenger at this time." />
	<string id="dots_messenger_disabled" text="{=dots_messenger_disabled}The messenger system is disabled in settings." />
	<string id="dots_messenger_not_available" text="{=dots_messenger_not_available}Messenger system not available." />
	<string id="dots_messenger_invalid_target" text="{=dots_messenger_invalid_target}Invalid target." />

	<!-- Send-side notifications -->
	<string id="dots_messenger_cannot_send" text="{=dots_messenger_cannot_send}Cannot Send Messenger" />
	<string id="dots_messenger_no_gold" text="{=dots_messenger_no_gold}Not enough gold! You need {COST} denars." />
	<string id="dots_messenger_already_sent" text="{=dots_messenger_already_sent}A messenger has already been dispatched to this person." />
	<string id="dots_messenger_hero_dead" text="{=dots_messenger_hero_dead}{HERO_NAME} is dead." />
	<string id="dots_messenger_hero_prisoner" text="{=dots_messenger_hero_prisoner}{HERO_NAME} is imprisoned and cannot receive messengers." />
	<string id="dots_messenger_hero_fugitive" text="{=dots_messenger_hero_fugitive}{HERO_NAME} is a fugitive and cannot be found." />
	<string id="dots_messenger_hero_child" text="{=dots_messenger_hero_child}{HERO_NAME} is too young to receive messengers." />
	<string id="dots_messenger_confused" text="{=dots_messenger_confused}The messenger seems confused — they were trying to reach someone in your own party!" />
	<string id="dots_messenger_sent" text="{=dots_messenger_sent}A messenger has been dispatched to {HERO_NAME} and will arrive within {DAYS} days." />
	<string id="dots_messenger_sent_title" text="{=dots_messenger_sent_title}Messenger Sent" />

	<!-- Arrival -->
	<string id="dots_messenger_arrived" text="{=dots_messenger_arrived}A messenger from {HERO_NAME} has arrived. Do you wish to speak with them?" />
	<string id="dots_messenger_arrived_title" text="{=dots_messenger_arrived_title}Messenger Arrived" />
	<string id="dots_messenger_speak" text="{=dots_messenger_speak}Speak" />
	<string id="dots_messenger_dismiss" text="{=dots_messenger_dismiss}Dismiss" />

	<!-- Accident / error -->
	<string id="dots_messenger_lost" text="{=dots_messenger_lost}Your messenger to {HERO_NAME} was ambushed by bandits and never arrived." />
	<string id="dots_messenger_lost_title" text="{=dots_messenger_lost_title}Messenger Lost" />
	<string id="dots_messenger_error" text="{=dots_messenger_error}Messenger Error" />

	<!-- In-conversation dialog hook -->
	<string id="dots_messenger_dialog_init" text="{=dots_messenger_dialog_init}I may need to send you a message later. Can I dispatch a messenger to you?" />
	<string id="dots_messenger_dialog_npc_accept" text="{=dots_messenger_dialog_npc_accept}Of course. I'll make sure to receive your messenger when they arrive." />
	<string id="dots_messenger_dialog_send" text="{=dots_messenger_dialog_send}Send the messenger ({COST} denars)" />
	<string id="dots_messenger_dialog_decline" text="{=dots_messenger_dialog_decline}On second thought, never mind." />
	<string id="dots_messenger_dialog_decline_ack" text="{=dots_messenger_dialog_decline_ack}As you wish." />
	<string id="dots_messenger_dialog_sent" text="{=dots_messenger_dialog_sent}I'll be expecting your messenger then." />
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -Path Main\\DOTS.csproj,Main\\SubModule.cs -Pattern 'UIExtender|Register.*Prefab|ViewModelMixin|UIPrefab|UIExtenderEx' -Context 2" in C:\Users\mikew\source\repos\DOTS
 succeeded in 463ms:

  Main\DOTS.csproj:40:			<Private>False</Private>
  Main\DOTS.csproj:41:		</Reference>
...
[7m[0m  Main\DOTS.csproj:43:			<HintPath>%(Identity)</HintPath>[0m
[7m[0m  Main\DOTS.csproj:44:			<Private>False</Private>[0m
...
> Main\SubModule.cs:83:        _[7muiExtender[0m = UIExtender.Create("DOTS");[0m
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Recurse -File Main | Select-String -Pattern 'new MessengerCampaignBehavior|MessengerCampaignBehavior\\(' | Select-Object Path,LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
 succeeded in 31462ms:

[32;1mPath                                                                                  [0m[32;1m LineNumber[0m[32;1m Line[0m
[32;1m----                                                                                  [0m [32;1m----------[0m [32;1m----[0m
C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerCampaignBehavior.cs         34     public Messenger…


exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content Main'"\\Features\\Messengers\\UI\\MessengerEncyclopediaMixin.cs | ForEach-Object { '{0,4}: {1}' -f "'$i, $_; $i++ } | Select-Object -First 130' in C:\Users\mikew\source\repos\DOTS
 succeeded in 488ms:
   ...
   7: using TaleWorlds.Localization;
   8: 
   9: namespace DOTS.Features.Messengers.UI;
  10: 
  ...
  22:     {
  23:         _service = DOTS.IoC.Resolve<IMessengerService>();
  24:         _settings = DOTS.IoC.Resolve<IMessengerSettingsProvider>();
  25:         _sendMessengerHint = new HintViewModel();
  26:         _sendMessengerActionName = new TextObject("{=dots_send_messenger}Send Messenger").ToString();
  27:     }
  28: 
  ...
  48:             SendMessengerHint = new HintViewModel(new TextObject("{=dots_messenger_target_unavailable}This person cannot be reached by messenger at this time."));
  49:             return;
  50:         }
  51: 
  ...
  55:             SendMessengerHint = new HintViewModel(new TextObject("{=dots_messenger_disabled}The messenger system is disabled in settings."));
  56:             return;
  57:         }
  58: 
  ...
  63:             SendMessengerHint = new HintViewModel(new TextObject("{=dots_messenger_not_available}Messenger system not available."));
  64:             return;
  65:         }
  66: 
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content Main'"\\Features\\StartupResources\\StartupResourcesConfigProvider.cs | ForEach-Object { '{0,4}: {1}' -f "'$i, $_; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 426ms:
   1: using System;
   2: using System.Collections.Generic;
   ...
   6: using DOTS.Core.Infrastructure;
   7: using DOTS.Core.Logging;
   8: using DOTS.Features.StartupResources.Config;
   9: 
  10: namespace DOTS.Features.StartupResources;
  11: 
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$dll='"'E:\\Steam\\steamapps\\common\\Mount & Blade II Bannerlord\\bin\\Win64_Shipping_Client\\TaleWorlds.MountAndBlade.dll'; ilspycmd -t TaleWorlds.MountAndBlade.IMissionListener "'$dll' in C:\Users\mikew\source\repos\DOTS
 succeeded in 550ms:
using TaleWorlds.Core;
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$dll='"'E:\\Steam\\steamapps\\common\\Mount & Blade II Bannerlord\\bin\\Win64_Shipping_Client\\TaleWorlds.CampaignSystem.dll'; ilspycmd -t TaleWorlds.CampaignSystem.CampaignVec2 "'$dll | Select-String -Pattern '"'CampaignVec2\\(' -Context 1" in C:\Users\mikew\source\repos\DOTS
 succeeded in 932ms:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-Content Main\\_Module\\ModuleData\\dots_cc_strings.xml -Head 10; Get-Content Main\\_Module\\ModuleData\\dots_named_companion_strings.xml -Head 5" in C:\Users\mikew\source\repos\DOTS
...
<strings>
	...
	<string id="dots_cc_dots_parent_gondor_1_text" text="{=dots_cc_dots_parent_gondor_1_text}Noble Houses of Gondor" />

[31;1mGet-Content: [0m
[31;1m[36;1mLine |[0m
[31;1m[36;1m[36;1m   2 | [0m … l -Head 10; [36;1mGet-Content Main\_Module\ModuleData\dots_named_companion_[0m …[0m
[31;1m[36;1m[36;1m[0m[36;1m[0m[36;1m     | [31;1m               ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[0m
[31;1m[36;1m[36;1m[0m[36;1m[0m[36;1m[31;1m[31;1m[36;1m     | [31;1mCannot find path 'C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\dots_named_companion_strings.xml' because it does not exist.[0m
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command 'git diff -- DOTS.Tests/Features/CharacterCreation/CharacterCreationContentServiceTests.cs | Select-Object -First 120' in C:\Users\mikew\source\repos\DOTS
 succeeded in 431ms:
diff --git a/DOTS.Tests/Features/CharacterCreation/CharacterCreationContentServiceTests.cs b/DOTS.Tests/Features/CharacterCreation/CharacterCreationContentServiceTests.cs
index 302528d..042f65f 100644
--- a/DOTS.Tests/Features/CharacterCreation/CharacterCreationContentServiceTests.cs
+++ b/DOTS.Tests/Features/CharacterCreation/CharacterCreationContentServiceTests.cs
@@ -5,6 +5,7 @@ using DOTS.Core.Domain;
 using DOTS.Core.Logging;
 using DOTS.Features.CharacterCreation;
 using DOTS.Features.CharacterCreation.Models;
+using DOTS.Features.StartupResources;
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command 'git diff -- CHANGELOG.md | Select-Object -First 120' in C:\Users\mikew\source\repos\DOTS
 succeeded in 444ms:
...
+
+Adds two adjacent capabilities the LOTRAOM 1.2.12 `StartingEquipmentGold/` module provided that DOTS had only half-built: configurable per-culture **player starting funds** at character-creation finalize, and **persistence** of the youth option's equipment roster onto `Hero.MainHero.BattleEquipment` / `CivilianEquipment` (previously the CC preview was visual-only — the player exited CC with vanilla default equipment regardless of the option chosen).
+
...
+
+**Out of scope (deliberate):** per-youth-option gold (per-culture only this session), starting items / starting troops (LOTRAOM had this; CareerSystem covers troop starts in DOTS), MCM live retuning. The visual `UpdateYouthEquipment` preview is preserved unchanged — it's orthogonal to persistence.
+
...
+
+Refactored the developer-built `SiegeDismount` module (one of seven dropped at `Downloads/Features_fixed/`) into DOTS's adapter / service / IoC pattern. The original was a standalone Bannerlord module with its own `SubModule.xml`, `MissionBehavior`, and MCM settings; this commit replaces it with `Main/Features/SiegeDismount/` so it ships as part of the DOTS DLL with the same MCM, logging, and toggle conventions as the rest of DOTS.
+
...
+- MCM settings folded into [`DotsSettings.cs`](Main/Features/DotsSettings.cs) under group `Battle Tactics / Siege Dismount` (3 settings: Enable, Behavior dropdown 0-3, Debug)
...
+
+**Tests:** 24 unit tests in [`SiegeDismountServiceTests`](DOTS.Tests/Features/SiegeDismount/SiegeDismountServiceTests.cs) covering disable paths, all four behavior modes, scene-name siege detection (5 keyword variants), idempotent end, and four logging contracts. Build green, 1340/1340 tests pass.
+
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -Path CHANGELOG.md -Pattern 'Messenger|SiegeDismount|Starting' -Context 1" in C:\Users\mikew\source\repos\DOTS
 succeeded in 459ms:
...
> CHANGELOG.md:7:Adds two adjacent capabilities the LOTRAOM 1.2.12 `[7mStarting[0mEquipmentGold/` [0m[7m[0mmodule [0m[7m[0mprovided [0m[7m[0mthat [0m[7m[0mDOTS [0m
...
[7m[0m/ [0m[7m[0mstarting [0m[7m[0mtroops [0m[7m[0m(LOTRAOM [0m[7m[0mhad [0m[7m[0mthis; [0m[7m[0mCareerSystem [0m[7m[0mcovers [0m[7m[0mtroop [0m[7m[0mstarts [0m[7m[0min [0m[7m[0mDOTS), [0m[7m[0mMCM [0m[7m[0mlive [0m[7m[0mretuning. [0m[7m[0mThe [0m[7m[0mvisual [0m
...
editing `ModuleData/MCM/Global/DOTS.json` to set `SiegeMountBehavior` outside `[0, 3]` produced an undefined enum 
...
[7m[0m`Downloads/Features_fixed/`) [0m[7m[0minto [0m[7m[0mDOTS's [0m[7m[0madapter [0m[7m[0m/ [0m[7m[0mservice [0m[7m[0m/ [0m[7m[0mIoC [0m[7m[0mpattern. [0m[7m[0mThe [0m[7m[0moriginal [0m[7m[0mwas [0m[7m[0ma [0m[7m[0mstandalone [0m[7m[0mBannerlord [0m
...
[7m[0m`Main/Features/SiegeDismount/` [0m[7m[0mso [0m[7m[0mit [0m[7m[0mships [0m[7m[0mas [0m[7m[0mpart [0m[7m[0mof [0m[7m[0mthe [0m[7m[0mDOTS [0m[7m[0mDLL [0m[7m[0mwith [0m[7m[0mthe [0m[7m[0msame [0m[7m[0mMCM, [0m[7m[0mlogging, [0m[7m[0mand [0m[7m[0mtoggle [0m[7m[0mconventions [0m
[7m[0mas [0m[7m[0mthe [0m[7m[0mrest [0m[7m[0mof [0m[7m[0mDOTS.[0m
...
[7m [0m[7m [0m[7m[0mCHANGELOG.md:76:- [0m[7m[0mMCM [0m[7m[0msettings [0m[7m[0mfolded [0m[7m[0minto [0m[7m[0m[`DotsSettings.cs`](Main/Features/DotsSettings.cs) [0m[7m[0munder [0m[7m[0mgroup [0m[7m[0m`Battle [0m
...
[`[7mSiegeDismount[0mServiceTests`](DOTS.Tests/Features/SiegeDismount/SiegeDismountServiceTests.cs) [0m[7m[0mcovering [0m[7m[0mdisable [0m[7m[0mpaths, [0m
...
[7m[0m  CHANGELOG.md:296:[0m
  CHANGELOG.md:1149:
> CHANGELOG.md:1150:- `DotsAllianceModel.GetScoreOf[7mStarting[0mAlliance` [0m[7m[0m— [0m[7m[0mremoved [0m[7m[0m`IFaction [0m[7m[0mevaluatingFaction` [0m[7m[0mparameter [0m
[7m[0m(dropped [0m[7m[0min [0m[7m[0mv1.4.0 [0m[7m[0mbase [0m[7m[0mclass)[0m
[7m [0m[7m [0m[7m[0mCHANGELOG.md:1151:- [0m[7m[0m`DotsBattleRewardModel.CalculateRenownGain` [0m[7m[0m— [0m[7m[0madded [0m[7m[0m`float [0m[7m[0mrenownMultiplierForWinnerSide` [0m[7m[0mand [0m
...
descriptors to `dots_module_strings.xml`
...
`Culture.abanissa` to `dots_education_character_templates.xml` — without these the character creation education stage 
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Recurse -File Main\\Features\\CareerSystem | Select-String -Pattern 'GiveGold|Gold|Equipment|SelectedTitleType|BattleEquipment|ItemRoster|MemberRoster' | Select-Object Path,LineNumber,Line -First 100" in C:\Users\mikew\source\repos\DOTS
 succeeded in 454ms:

[32;1mPath                                                                                   [0m[32;1m LineNumber[0m[32;1m Line[0m
[32;1m----                                                                                   [0m [32;1m----------[0m [32;1m----[0m
C:\Users\mikew\source\repos\DOTS\Main\Features\CareerSystem\Domain\PassiveEffectType.cs         27     EquipmentWeight…


exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-Content Main\\_Module\\ModuleData\\charactercreation\\cultures.json | Select-Object -First 120" in C:\Users\mikew\source\repos\DOTS
 succeeded in 437ms:
[
  {
    "culture_id": "gondor",
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-Content Main\\_Module\\ModuleData\\charactercreation\\cultures.json | Select-Object -Skip 120 -First 120" in C:\Users\mikew\source\repos\DOTS
 succeeded in 426ms:
  },
  {
    "culture_id": "sturgia",
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -Path Main\\_Module\\ModuleData\\charactercreation\\youth_menu.json -Pattern '\"culture_id\": \"(shaghana|abanissa)\"' | Measure-Object; Select-String -Path Main\\_Module\\ModuleData\\equipmentsets\\dots_char_creation_equipment.xml -Pattern 'player_char_creation_(shaghana|abanissa)_' | Select-Object -First 5 LineNumber,Line" in C:\Users\mikew\source\repos\DOTS
 succeeded in 561ms:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem Main\\_Module\\ModuleData\\charactercreation\\*.json | Select-String -Pattern '\"culture_id\": \"(shaghana|abanissa)\"' | Select-Object Path,LineNumber,Line -First 20" in C:\Users\mikew\source\repos\DOTS
 succeeded in 460ms:

[32;1mPath                                                                                    [0m[32;1m LineNumber[0m[32;1m Line[0m
[32;1m----                                                                                    [0m [32;1m----------[0m [32;1m----[0m
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\cultures.json        143     "culture_id": …
C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\charactercreation\cultures.json        153     "culture_id": …
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Select-String -Path Main\\_Module\\ModuleData\\dots_spcultures.xml -Pattern 'id=\"(shaghana|abanissa)\"' -Context 0,1; Get-ChildItem Main\\_Module\\ModuleData -Recurse -File -Include *.xml,*.xslt | Select-String -Pattern 'id=\"(shaghana|abanissa)\"' | Select-Object Path,LineNumber,Line -First 20" in C:\Users\mikew\source\repos\DOTS
 succeeded in 536ms:

> Main\_Module\ModuleData\dots_spcultures.xml:3639:    [7mid="shaghana"[0m
[7m[0m  Main\_Module\ModuleData\dots_spcultures.xml:3640:    name="{=aom_shaghana_name}Shaghâna"[0m
> Main\_Module\ModuleData\dots_spcultures.xml:3903:    [7mid="abanissa"[0m
[7m[0m  Main\_Module\ModuleData\dots_spcultures.xml:3904:    name="{=aom_abanissa_name}Âbanissa"[0m

[32;1mPath       : [0mC:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\special_resources\special_resources_config.xml
...
[32;1mPath       : [0mC:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\dots_spcultures.xml
...
[32;1mPath       : [0mC:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\dots_spkingdoms.xml
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content Main'"\\_Module\\ModuleData\\startup_resources\\startup_resources_config.xml | ForEach-Object { '{0,4}: {1}' -f "'$i, $_; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 428ms:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content Main'"\\Features\\Messengers\\MessengerCampaignBehavior.cs | ForEach-Object { if ("'$i -le 120 -or ($i -ge 410 -and $i -le 440)) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 434ms:
  ...
  14: using DOTS.Core.Logging;
  15: using DOTS.Features.Messengers.Domain;
  16: 
  17: namespace DOTS.Features.Messengers;
  18: 
  ...
  59:             dataStore.SyncData("_dots_messengers", ref snapshot);
  60:         }
  61:         else
  62:         {
  63:             Dictionary<string, string> snapshot = null;
  64:             dataStore.SyncData("_dots_messengers", ref snapshot);
  ...
  81:         {
  82:             ShowInquiry(
  83:                 new TextObject("{=dots_messenger_cannot_send}Cannot Send Messenger").ToString(),
  ...
  98: 
  99:         var sentText = new TextObject("{=dots_messenger_sent}A messenger has been dispatched to {HERO_NAME} and will arrive within {DAYS} days.");
 100:         sentText.SetTextVariable("HERO_NAME", targetHero.Name);
 101:         sentText.SetTextVariable("DAYS", _settings.MessengerTravelDays);
 102:         ShowInquiry(
 103:             new TextObject("{=dots_messenger_sent_title}Messenger Sent").ToString(),
 ...
 412:             "dots_messenger_dialog_decline_ack",
 413:             "dots_messenger_dialog_decline_ack",
 414:             "close_window",
 415:             "{=dots_messenger_dialog_decline_ack}As you wish.",
 416:             null, null);
 417:     }
 418: 
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$dll='"'E:\\Steam\\steamapps\\common\\Mount & Blade II Bannerlord\\bin\\Win64_Shipping_Client\\TaleWorlds.CampaignSystem.dll'; ilspycmd -t TaleWorlds.CampaignSystem.Campaign "'$dll | Select-String -Pattern '"'GetCampaignBehavior' -Context 1" in C:\Users\mikew\source\repos\DOTS
 succeeded in 1356ms:
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content Main'"\\IoC.cs | ForEach-Object { if ("'$i -ge 74 -and $i -le 82) { '"'{0,4}: {1}' -f "'$i, $_ }; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 444ms:
  74:         SpecialResourcesIoC.RegisterSpecialResourcesFeature(container);
  75:         CareerSystemIoC.RegisterCareerSystemFeature(container);
  76:         SettlementGuardsIoC.RegisterSettlementGuardsFeature(container);
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command '$i=1; Get-Content Main'"\\Features\\Messengers\\MessengerConfigProvider.cs | ForEach-Object { '{0,4}: {1}' -f "'$i, $_; $i++ }' in C:\Users\mikew\source\repos\DOTS
 succeeded in 437ms:
   1: using System;
   2: using System.IO;
   3: using Newtonsoft.Json;
   4: using DOTS.Core.Infrastructure;
   5: using DOTS.Core.Logging;
   6: 
   7: namespace DOTS.Features.Messengers;
   8: 
...
exec
"C:\\Program Files\\PowerShell\\7\\pwsh.exe" -Command "Get-ChildItem -Recurse -File Main\\Features | Select-String -Pattern 'Vec2' | Select-Object Path,LineNumber,Line -First 20" in C:\Users\mikew\source\repos\DOTS
 succeeded in 437ms:

[32;1mPath                                                                                               [0m[32;1m LineNumber[0m[32;1m Line[0m
[32;1m----                                                                                               [0m [32;1m----------[0m [32;1m----[0m
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs         24     pri…
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs         26        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs         27        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs         28        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs         31        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs         32        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs         33        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs         35        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs         37        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs         38        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs         42        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs        325        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs        326        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs        329        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs        330        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs        395        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs        403        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs        410        …
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs        415     pri…
C:\Users\mikew\source\repos\DOTS\Main\Features\AdvancedCombat\AutonomousMovementPlayerController.cs        429     pri…


codex
The StartingEquipmentGold path still has a wrong v1.3.15 equipment fallback guard and misses two selectable cultures in the new playerGold config. The current workspace also includes Messenger changes that register services/UI without installing the campaign behavior and violate DOTS entry-point/config-validation rules.

Full review comments:

- [P1] Guard civilian equipment against the civilian dead singleton — C:\Users\mikew\source\repos\DOTS\Main\Adapters\PlayerEquipmentAdapter.cs:32-33
...
- [P2] Seed player gold for all selectable cultures — C:\Users\mikew\source\repos\DOTS\Main\_Module\ModuleData\startup_resources\startup_resources_config.xml:31-32
...
- [P1] Add the messenger campaign behavior to game start — C:\Users\mikew\source\repos\DOTS\Main\IoC.cs:80-80
...
- [P2] Keep MessengerCampaignBehavior as a thin entry point — C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerCampaignBehavior.cs:19-19
...
- [P2] Reject NaN messenger config floats — C:\Users\mikew\source\repos\DOTS\Main\Features\Messengers\MessengerConfigProvider.cs:60-68
