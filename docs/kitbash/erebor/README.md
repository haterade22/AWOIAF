...
`Modules/DOTS_Map/AssetSources/Scenes/erebor/` and its packaged form at
`Modules/DOTS_Map/Assets/Scenes/erebor/`.
...
| **Total** | **~164** | Matches `dots_erebor_kitbash.xml` |

## Related files

- Kitbash prefab: `Modules/DOTS_Map/Prefabs/dots_erebor_kitbash.xml` (164 entries)
- Source FBX: `Modules/DOTS_Map/AssetSources/Scenes/erebor/{meshes,walls}/*.fbx`
- Packaged meshes: `Modules/DOTS_Map/Assets/Scenes/erebor/{meshes,walls}/*_geo.tpac`
