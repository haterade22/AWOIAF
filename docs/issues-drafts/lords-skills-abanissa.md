...
(2026-05-27), Abanissa adult NPCs in DOTS had empty `<skills/>` blocks or vanilla-default
...
- All adult Abanissa NPCs receive one of the shared DOTS archetype templates (10 base
...
DOTS-invented coastal sub-culture (8 male warlords ages 28-52). Same treatment as Shaghana — default lord/elder_lord archetypes via age.
