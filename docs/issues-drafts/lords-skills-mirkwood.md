...
(2026-05-27), Mirkwood (Woodland Realm) adult NPCs in DOTS had empty `<skills/>` blocks or vanilla-default
...
- All adult Mirkwood (Woodland Realm) NPCs receive one of the shared DOTS archetype templates (10 base
...
Thranduil (Elvenking, `elf_king` archetype: OneHanded 290, Bow 295, Charm 285, Leadership 290), Legolas (Bow 295, Athletics 295 — Fellowship member, master archer), Lothuial (DOTS queen), Feren (captain), Galion (butler/steward). Other Mirkwood elves use `elf_warrior` / `elf_archer` / `elf_lady`
