...
(2026-05-27), Lothlórien adult NPCs in DOTS had empty `<skills/>` blocks or vanilla-default
...
- All adult Lothlórien NPCs receive one of the shared DOTS archetype templates (10 base
...
Galadriel (Lady of Lothlórien, ~8000+ yrs Noldor, Ring-bearer — capped at Charm 300, Leadership 300, Tactics 295, Steward 295, Medicine 290, Crafting 290; only character to hit Charm 300), Celeborn (Lord of Lothlórien, ancient Sindar — OneHanded 290, Polearm 295, Leadership 290), 1 placeholder lord (DOTS-invented)
...
**Notes:** Galadriel + Denethor are the only two characters hitting 300 in any skill. Justified: Galadriel is one of the most powerful Elves in Middle-earth. Marchwardens (Haldir, Rúmil, Orophin) are in Mirkwood not Lothlórien per DOTS's data.
