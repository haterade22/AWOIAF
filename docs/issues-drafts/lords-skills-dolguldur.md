...
(2026-05-27), Dol Guldur adult NPCs in DOTS had empty `<skills/>` blocks or vanilla-default
...
- All adult Dol Guldur NPCs receive one of the shared DOTS archetype templates (10 base
...
All DOTS-invented orc names (no canonical Khamûl entry in lords.xml — he'd be a separate Nazgûl). 6 compound chieftains (D1_1, D2_1, D3_1, etc.) marked as `orc_chieftain`; the rest as `orc_warrior` / `orc_female`
