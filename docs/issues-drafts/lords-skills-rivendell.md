...
(2026-05-27), Rivendell (Imladris) adult NPCs in DOTS had empty `<skills/>` blocks or vanilla-default
...
- All adult Rivendell (Imladris) NPCs receive one of the shared DOTS archetype templates (10 base
