...
(2026-05-27), Dale (Bardings) adult NPCs in DOTS had empty `<skills/>` blocks or vanilla-default
...
- All adult Dale (Bardings) NPCs receive one of the shared DOTS archetype templates (10 base
...
DOTS Dale roster is mostly DOTS-invented Slavic-named wives + nobles (Apolanea, Lilizha, etc.) — bio-driven via `dale_lord` / `dale_bowman` archetypes. Lore: King Bard II succeeded Brand (slain at Battle of Dale, T.A. 3019). High Bow + Trade emphasis for Northmen bowmen of Esgaroth.
...
**Notes:** Bardings = Northmen archer-merchants; archetypes weight Bow 260-275, Trade 180-220. No explicit canonical overrides — DOTS names don't map to Tolkien-canon Bard/Brand.
