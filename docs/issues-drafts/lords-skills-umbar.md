...
(2026-05-27), Umbar (Corsairs) adult NPCs in DOTS had empty `<skills/>` blocks or vanilla-default
...
- All adult Umbar (Corsairs) NPCs receive one of the shared DOTS archetype templates (10 base
...
DOTS Umbar has 10 Black Númenórean corsair lords with authentic Adunaic names (Ar-Gimilkhâd, Gimilzâr, Gimilthân, Pharaz�n, Zimraphel, Azraphel, Belkazar, Pharakhân, Inkaldâr, Zimrathâr). Adunaic `Ar-` prefix = king/highest noble. All use `corsair_lord` / `corsair_captain` / `young_lord` archetypes.
