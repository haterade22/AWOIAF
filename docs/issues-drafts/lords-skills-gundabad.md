...
(2026-05-27), Mount Gundabad adult NPCs in DOTS had empty `<skills/>` blocks or vanilla-default
...
- All adult Mount Gundabad NPCs receive one of the shared DOTS archetype templates (10 base
...
All DOTS-invented pale_uruk names. 5 compound chieftains (G1_1..G5_1); Bolgath (G4_1) gets a slight bump as Bolg-evoking name (OneHanded 285, Leadership 280)
...
**Notes:** Pure archetype application. Pale Uruks are stronger than Mordor orcs in lore but DOTS uses the same race for both.
