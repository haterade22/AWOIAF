...
(2026-05-27), Dunland (Hillmen / Saruman's auxiliaries) adult NPCs in DOTS had empty `<skills/>` blocks or vanilla-default
...
- All adult Dunland (Hillmen / Saruman's auxiliaries) NPCs receive one of the shared DOTS archetype templates (10 base
...
DOTS Dunland is all-female shieldmaiden + raider warband leaders (Eldith Grey-Claw, Sigga Wyrmbane, Yrsa the Winter Boar, Freya Clawrend, etc.) — Norse-themed names. Auto-assigned to `dunland_warrior` / `dunland_raider` / `dunland_brenin` archetypes via bio keyword scan. No canonical Tolkien named characters in DOTS's roster.
