...
(2026-05-27), Khand (Variags) adult NPCs in DOTS had empty `<skills/>` blocks or vanilla-default
...
- All adult Khand (Variags) NPCs receive one of the shared DOTS archetype templates (10 base
...
DOTS Khand has Welsh/Gaelic-named warband leaders + wives. Auto-assigned to `variag_lord` / `variag_lady` / dunland_raider archetypes via bio keyword scan.
