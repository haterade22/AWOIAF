# Culture Creation Checklist for DOTS

## Current State
- **10 custom cultures** defined in `dots_spcultures.xml`: erebor, rivendell, mirkwood, lothlorien, isengard, gundabad, umbar, dolguldur, gondor, mordor
...
**File:** `Main/_Module/ModuleData/dots_spcultures.xml`
...
**File:** Create `Main/_Module/ModuleData/dots_equipment_sets_{culture}.xml`
...
**File:** Add entries to `Main/_Module/ModuleData/dots_partyTemplates.xml`
...
**File:** Add to `Main/_Module/ModuleData/dots_spkingdoms.xml`
...
**File:** `Main/_Module/ModuleData/dots_module_strings.xml`
- Culture name/description strings with `{=aom_{culture}_*}` keys
- All name lists use inline `{=key}` format in `dots_spcultures.xml`
...
| Culture | Missing |
|---------|---------|
| Umbar | No `dots_equipment_sets_umbar.xml` |
| Dale | No `dots_equipment_sets_dale.xml` |
| Khand | No `dots_equipment_sets_khand.xml`, no `troops_khand.xml` |
| Lothlorien | No `dots_equipment_sets_lothlorien.xml` |
...
| # | File | Action |
|---|------|--------|
| 1 | `dots_spcultures.xml` | Add ~350-line `<Culture>` block |
...
| 4 | `dots_equipment_sets_{culture}.xml` | **Create** (battle/civilian/troop equipment) |
| 5 | `dots_partyTemplates.xml` | Add ~8 party template entries |
| 6 | `dots_spkingdoms.xml` | Add kingdom entry |
...
| 12 | `dots_module_strings.xml` | Add localization strings |
