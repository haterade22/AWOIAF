...
using DOTS.Core.Validation;
using DOTS.SceneScripts.Roads;

namespace DOTS.SceneScripts;
...
public class CS_Road : ScriptComponentBehavior
{
    ...
    {
        Debug.Print($"DOTS: {message}", 0, Debug.DebugColor.Yellow, LogTag);
    }

    private static void LogInfo(string message)
    {
        Debug.Print($"DOTS: {message}", 0, Debug.DebugColor.White, LogTag);
    }
