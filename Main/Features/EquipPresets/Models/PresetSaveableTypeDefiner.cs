...
namespace DOTS.Features.EquipPresets.Models;
...
///
/// BaseId 726900501 — verified unique across DOTS at port time (no other SaveableTypeDefiner
/// in Main/). Item-ref id 101, preset id 102 (under the base id, both unique). Document the
/// chosen range here so future DOTS features know to pick a different base id.
/// </summary>
