...
public class FiefHubCampaignBehavior : CampaignBehaviorBase
{
    ...
    public void OnSessionLaunched(CampaignGameStarter starter)
    {
        ...
        starter.AddGameMenuOption("fief_hub", "fief_hub_prev", "{=dots_fief_hub_prev}Previous fief",
        ...
        starter.AddGameMenuOption("fief_hub", "fief_hub_next", "{=dots_fief_hub_next}Next fief",
            args => { args.optionLeaveType = GameMenuOption.LeaveType.Continue; return _settings.EnableFiefManagement && _presenter.Count > 1; },
            args => { _presenter.StepNext(); GameMenu.SwitchToMenu("fief_hub"); },
            isLeave: false, index: 1);

        starter.AddGameMenuOption("fief_hub", "fief_hub_manage", "{=dots_fief_hub_manage}Manage this fief",
            args =>
            {
        ...
        starter.AddGameMenuOption("fief_hub", "fief_hub_leave", "{=dots_fief_hub_leave}Leave",
