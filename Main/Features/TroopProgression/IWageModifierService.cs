...
/// extracted from <c>DotsPartyWageModel</c> per gamemodels.md rule 4 (thin override
...
/// ADR-007. Vanilla's <c>KhuzaitRecruitUpgradeFeat</c> is deliberately omitted — DOTS replaces
