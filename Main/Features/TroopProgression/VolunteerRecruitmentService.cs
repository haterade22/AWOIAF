...
public class VolunteerRecruitmentService : IVolunteerRecruitmentService
{
    ...
    // Settlements/clans absent — Gundabad in DOTS is hostile faction; volunteer recruitment
    ...
    {
        // dots_spider_creature: the giant spider, recruitable at Dol Guldur fiefs only. It rides in the
        ...
        AddSettlement("town_DG1",   ("dg_goblin_slave", 7), ("dg_khamul_shadow_initiate", 3), ("dots_spider_creature", 1));
        AddSettlement("castle_DG1", ("dg_goblin_slave", 7), ("dg_khamul_shadow_initiate", 3), ("dots_spider_creature", 1));
        AddSettlement("castle_DG2", ("dg_goblin_slave", 7), ("dg_khamul_shadow_initiate", 3), ("dots_spider_creature", 1));
        AddSettlement("castle_DG3", ("dg_goblin_slave", 7), ("dg_khamul_shadow_initiate", 3), ("dots_spider_creature", 1));
    }
    ...
    private static void InitializeDolGuldurCulture()
    {
        CultureMap["dolguldur"] = new List<VolunteerChance>
        {
            ...
            new VolunteerChance("dots_spider_creature", 1)
        };
    }
