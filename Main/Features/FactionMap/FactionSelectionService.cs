...
public class FactionSelectionService : IFactionSelectionService
{
    ...
    public string FormatDifficultyText(int difficulty)
    {
        ...
        {
            1 => "{=dots_faction_difficulty_1}Difficulty: Very Easy",
            2 => "{=dots_faction_difficulty_2}Difficulty: Easy",
            3 => "{=dots_faction_difficulty_3}Difficulty: Medium",
            4 => "{=dots_faction_difficulty_4}Difficulty: Medium-Hard",
            5 => "{=dots_faction_difficulty_5}Difficulty: Hard",
            6 => "{=dots_faction_difficulty_6}Difficulty: Very Hard",
            7 => "{=dots_faction_difficulty_7}Difficulty: Extreme",
            _ => "",
        };
    }
