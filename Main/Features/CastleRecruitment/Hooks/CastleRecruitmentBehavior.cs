...
namespace DOTS.Features.CastleRecruitment.Hooks;
...
{
    private const string RecruitOptionId = "dots_castle_recruit_volunteers";
    ...
    public override void SyncData(IDataStore dataStore)
    {
        ...
        // volunteers live in Hero.VolunteerTypes. Nothing DOTS-specific to round-trip.
    }
    ...
    private void OnSessionLaunched(CampaignGameStarter starter)
    {
        ...
        // OnSessionLaunched (registered before DOTS behaviors), so the menu exists by now.
