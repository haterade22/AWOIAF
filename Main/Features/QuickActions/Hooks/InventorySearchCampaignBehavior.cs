...
namespace DOTS.Features.QuickActions.Hooks;
...
public sealed class InventorySearchCampaignBehavior : CampaignBehaviorBase
{
    ...
    public override void SyncData(IDataStore dataStore)
    {
        ...
        dataStore.SyncData("DOTS_IsInventorySearchAvailable", ref _isSearchAvailable);
        dataStore.SyncData("DOTS_InventorySearchVersion", ref _persistedVersion);
    }
