    ...
    public void OpenMenu(Action originalSellAll)
    {
        try
        {
            ...
            var data = new MultiSelectionInquiryData(
                titleText: new TextObject("{=dots_qa_title}Quick Actions").ToString(),
                descriptionText: new TextObject("{=dots_qa_desc}Select an action.").ToString(),
                inquiryElements: elements,
                isExitShown: true,
                minSelectableOptionCount: 1,
                maxSelectableOptionCount: 1,
                affirmativeText: new TextObject("{=dots_qa_ok}OK").ToString(),
                negativeText: new TextObject("{=dots_qa_cancel}Cancel").ToString(),
        ...
        if (_settings.ShowConfirmation && type != QuickActionType.OriginalSellAll)
        {
            try
            {
                InformationManager.ShowInquiry(new InquiryData(
                    new TextObject("{=dots_qa_confirm_title}Confirm").ToString(),
                    new TextObject("{=dots_qa_confirm_msg}Apply this bulk action?").ToString(),
                    isAffirmativeOptionShown: true,
                    isNegativeOptionShown: true,
                    affirmativeText: new TextObject("{=dots_qa_yes}Yes").ToString(),
                    negativeText: new TextObject("{=dots_qa_no}No").ToString(),
