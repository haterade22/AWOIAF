...
namespace DOTS.Features.ArmyTargeting.Models;

public class DotsTargetScoreModel : DefaultTargetScoreCalculatingModel
{
    private readonly IArmyTargetingService _service;

    public DotsTargetScoreModel(IArmyTargetingService service)
    {
        _service = service;
    }
