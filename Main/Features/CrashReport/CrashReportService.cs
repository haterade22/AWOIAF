...
using DOTS.Features.CrashReport.UI;
...
public sealed class CrashReportService : ICrashReportService
{
    ...
    private readonly DotsStateCollector _taomState;
    ...
    private ExceptionContext ComposeContext(Exception exception, string originatingPatchTarget, List<CollectorFailure> failures, bool offMainThread)
    {
        ...
        var taom = Safe(() => _taomState.Collect(), failures, "DotsState") ?? new DotsStateSnapshot(null, Array.Empty<SpecialResourceEntry>(), null, null, null);
