...
// Placeholder collector for DOTS-specific in-game state (career, resources, feats,
...
public sealed class DotsStateCollector
{
    ...
    public DotsStateSnapshot Collect()
    {
        return new DotsStateSnapshot(
            Career: Safe(_career),
