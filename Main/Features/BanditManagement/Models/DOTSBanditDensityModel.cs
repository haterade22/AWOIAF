...
namespace DOTS.Features.BanditManagement.Models;
...
/// </summary>
public class DotsBanditDensityModel : DefaultBanditDensityModel
{
    private readonly IBanditScalingService _scaling;

    public DotsBanditDensityModel(IBanditScalingService scaling)
    {
        _scaling = scaling;
    }
    ...
    // internal (not private) for direct unit testing via InternalsVisibleTo("DOTS.Tests") —
