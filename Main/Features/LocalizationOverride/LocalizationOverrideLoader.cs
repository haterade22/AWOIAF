...
namespace DOTS.Features.LocalizationOverride;

/// <summary>
/// Parses dots_module_strings.xml to extract English localization overrides.
///
/// Entries whose text attribute starts with {=VANILLA_ID} (where VANILLA_ID is NOT
/// prefixed with "dots_") are treated as overrides for hardcoded C# strings.
