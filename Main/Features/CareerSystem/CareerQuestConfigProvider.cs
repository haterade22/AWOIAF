...
/// <summary>
/// Loads career-quest definitions from <c>career_system/dots_career_quests.xml</c> and validates
...
public class CareerQuestConfigProvider : ICareerQuestConfigProvider
{
    ...
    public IReadOnlyList<CareerQuestDefinition> LoadQuests()
    {
        ...
        var path = Path.Combine(_pathService.ModuleDataPath, "career_system", "dots_career_quests.xml");
        if (!File.Exists(path))
        {
