...
public class CareerPersistenceBehavior : CampaignBehaviorBase
{
    ...
    public override void SyncData(IDataStore dataStore)
    {
        ...
        dataStore.SyncData("_dots_careerIds", ref careerIds);
        dataStore.SyncData("_dots_careerChoices", ref choiceLists);
        dataStore.SyncData("_dots_careerTiers", ref tierLists);
        dataStore.SyncData("_dots_careerFlags", ref flagLists);
