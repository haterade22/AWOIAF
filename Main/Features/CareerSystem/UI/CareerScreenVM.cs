...
public class CareerScreenVM : ViewModel
{
        ...
        Action<string> onChooseSwitchTarget = null)
    {
        ...
        _screenTitle = isSwitchMode
            ? new TextObject("{=dots_career_switch_title}Choose Your Path").ToString()
            : new TextObject("{=dots_career_screen_title}Career").ToString();
        ...
        _switchModeSubtitle = new TextObject("{=dots_career_switch_subtitle}Eligible careers for your culture and standing.").ToString();
        _noTargetsMessage = new TextObject("{=dots_career_switch_no_targets}No eligible careers available for your culture and standing.").ToString();
