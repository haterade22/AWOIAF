...
/// engine (no manual registration). BaseId 726900701 — DOTS-unique, next in the 7269007xx series
...
/// verified 1.4.5). DOTS's definer bases step by 100, so the per-class localId MUST start at 101 (not 1)
