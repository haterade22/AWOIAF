...
namespace DOTS.Features.CareerSystem.Quests;
...
public class CareerQuest : QuestBase
{
    ...
    public override TextObject Title =>
        new TextObject(string.IsNullOrEmpty(_titleKey) ? "{=dots_cq_title}Career Quest" : _titleKey);
    ...
    public override string SpecialQuestType => "dots_career_quest";
    ...
    protected override void OnStartQuest()
    {
        ...
        _progress = new List<int>();
        _logs = new List<JournalLog>();
        var body = new TextObject(string.IsNullOrEmpty(_def.DescriptionKey) ? "{=dots_cq_body}Prove yourself." : _def.DescriptionKey);
        foreach (var obj in _def.Objectives)
        {
            var task = new TextObject(string.IsNullOrEmpty(obj.TaskKey) ? "{=dots_cq_task}Objective" : obj.TaskKey);
