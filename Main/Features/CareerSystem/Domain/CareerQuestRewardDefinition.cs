...
public enum CareerQuestRewardType
{
    ...
    /// Applied via the existing <c>ICareerDataService.UnlockTier</c> (persisted in <c>_dots_careerTiers</c>).
    /// </summary>
    UnlockTier,
    ...
    /// <summary>
    /// Set a string flag in the hero's career data (DOTS's clean equivalent of TOR's
...
/// <c>dots_career_quests.xml</c> and validated before use.
/// </summary>
