...
internal sealed class MessengerEncyclopediaMixin : BaseViewModelMixin<EncyclopediaHeroPageVM>
{
    ...
    public MessengerEncyclopediaMixin(EncyclopediaHeroPageVM viewModel) : base(viewModel)
    {
        ...
        _hintTargetUnavailable = new HintViewModel(new TextObject("{=dots_messenger_target_unavailable}This person cannot be reached by messenger at this time."));
        _hintMessengersDisabled = new HintViewModel(new TextObject("{=dots_messenger_disabled}The messenger system is disabled in settings."));
        _hintSystemUnavailable = new HintViewModel(new TextObject("{=dots_messenger_not_available}Messenger system not available."));
