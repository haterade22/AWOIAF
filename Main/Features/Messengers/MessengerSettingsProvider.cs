...
public class MessengerSettingsProvider : IMessengerSettingsProvider
{
    ...
    public int MessengerGoldCost => Clamp(DotsSettings.Instance?.MessengerGoldCost ?? 50, min: 10, max: 500, fallback: 50);
    public int MessengerTravelDays => Clamp(DotsSettings.Instance?.MessengerTravelDays ?? 3, min: 1, max: 10, fallback: 3);
